...
define( "RC_MSG_REMEMBER", "Sprawdź czy wszystkie ustawienia są prawidłowe.<br> Po zapisaniu ustawień kliknij na [Buduj listę słów].<br> Pamiętaj aby zainstalowac i umieścić na swojej stornie <a target=\"_blank\" href=\"http://www.joomla.royy.net/index.php/Modules/View-category.html?ascdesc=DESC&orderby=dmdatecounter\" >moduł Raf Cloud </a> ." );
...
define( "RC_DEFAULT_STRTOLOWER_DESC", "Funkcja zmiany zanaków z dużych na małe. Zmień na mb_strtolower tylko jesli masz problemy ze znakami specjalnymi." );
...
SEF Urls</b> w komponencie sh404sef. Musisz zainstalować <a target=\"_blank\" href=\"http://www.joomla.royy.net/index.php/View-document-details/28-Raf-Cloud-sh404SEF-plugin.html\" >sh404sef plugin </a>." );
