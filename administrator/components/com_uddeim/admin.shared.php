...
$versionstring="uddeIM 1.5/2008-12-01";		// version string for about boxes
$checkversion="1.5";						// version as above for check for update - this is the version we have
$configversion="1.1";						// this is the version number of the configuration file we expect to load
...
function uddeIMcheckCBE() {
	$pathtocbe = uddeIMgetPath('absolute_path')."/administrator/components/com_comprofiler/enhanced_admin/enhanced_config.php";
	if (file_exists($pathtocbe))
		return true;
	return false;
}

function uddeIMcheckCBE2() {
	$pathtocbe = uddeIMgetPath('absolute_path')."/administrator/components/com_cbe/enhanced_admin/enhanced_config.php";
	if (file_exists($pathtocbe))
		return true;
	return false;
}
