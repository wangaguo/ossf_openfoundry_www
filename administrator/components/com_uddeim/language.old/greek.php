...
DEFINE ('_UDDEADM_FILTER_P0', 'diabled');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>You have no%s messages%s in your%s.</b>');	// see next also six lines
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUBOX', ' outbox');
