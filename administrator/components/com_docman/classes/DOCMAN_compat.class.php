 ...
 * @version $Id: DOCMAN_compat.class.php 765 2009-01-05 20:55:57Z mathias $
 * @package DOCman_1.4
...
if($vmambo) { // Using Mambo v4.x or higher
	die('<a href="http://www.joomlatools.eu" title="DOCman Official Site"><img border="0" src="components/com_docman/images/dm_logo.png" title="DOCman Logo" /></a><h1>Please upgrade to <a href="http://www.joomla.org" target="_blank" title="Joomla!">Joomla!</a> for the best document management experience!</h1>');
