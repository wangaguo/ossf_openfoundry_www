...
// PHP - mcpuk	// 
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/mcpuk/browser.html?Type=images&Connector=connectors/php/connector.php' ;
...
// PHP - mcpuk	// 
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/mcpuk/browser.html?Type=images&Connector=connectors/php/connector.php' ;
...
// PHP - mcpuk	// 
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/mcpuk/browser.html?Type=images/Flash&Connector=connectors/php/connector.php' ;
FCKConfig.FlashBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.7 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight = FCKConfig.ScreenHeight * 0.7 ;	//70% ;

FCKConfig.LinkUpload = false ; // No es necesario con mcpuk
...
FCKConfig.ImageUpload = false ; // No es necesario con mcpuk
...
FCKConfig.FlashUpload = false ; // No es necesario con mcpuk
