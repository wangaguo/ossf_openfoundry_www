 ...
 * @version $Id: mod_docman_approval.php 561 2008-01-17 11:34:40Z mjaz $
 * @package DOCman_1.4
...
<table class="adminlist">
    ...
    if (!count($rows)) echo '<tr><td>' . _DML_MOD_NO_UNAPPROVED_DOCUMENTS . '</td></tr>';
    foreach ($rows as $row) {
        ?>
    	<tr>
            <td width="5%" style="text-align:center">
                <a href="index2.php?option=com_docman&amp;section=documents&amp;task=approve&cid[]=<?php echo $row->id?>&amp;redirect=index2.php%3Foption%3Dcom_docman">
