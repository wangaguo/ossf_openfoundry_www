 ...
 * @version $Id: categories.php 608 2008-02-18 13:31:26Z mjaz $
 * @package DOCman_1.4
...
function saveCategory()
{
    ...
    $row->checkin();
    $row->updateOrder("section='com_docman' AND parent_id=". (int) $row->parent_id);
    ...
    */
    ...
    if( $task == 'save' ) {
        $url = 'index2.php?option=com_docman&section=categories';
    } else { // $task = 'apply'
        $url = 'index2.php?option=com_docman&section=categories&task=edit&cid[0]='.$row->id;
    }
