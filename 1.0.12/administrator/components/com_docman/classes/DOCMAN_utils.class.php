 ...
 * @version $Id: DOCMAN_utils.class.php 561 2008-01-17 11:34:40Z mjaz $
 * @package DOCman_1.4
...
class DOCMAN_Utils
{
    ...
    function taskLink($task, $gid = '', $params = null, $sef = true, $indexfile = 'index.php')
    {
		...
		$link = $sef ?  sefRelToAbs($link) : $link;
        return $link;
    }
    ...
    function _rawLink($task, $gid = '', $params = null, $indexfile = 'index.php')
    {
        ...
        $link .= "&Itemid=" . ($Itemid ? $Itemid : DOCMAN_Utils::getItemid());
...
/*
    ...
    */
    ...
    function processContentBots( & $doc, $field = 'description' ) {
        ...
        // initialize objects
        $params     = new mosParameters( '' ); // fake params
        $row        = new stdClass();
