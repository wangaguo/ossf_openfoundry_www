...
function com_uninstall()
{
    ...
    @unlink( "$mosConfig_absolute_path/modules/mod_jflanguageselection_simplified_chinese.xml" );
    @unlink( "$mosConfig_absolute_path/modules/mod_jflanguageselection_traditional_chinese.xml" );
    ...
    @unlink( "$mosConfig_absolute_path/mambots/search/jfcontent.searchbot_simplified_chinese.xml" );
    @unlink( "$mosConfig_absolute_path/mambots/search/jfcontent.searchbot_traditional_chinese.xml" );
    ...
    @unlink( "$mosConfig_absolute_path/mambots/system/jfdatabase.systembot_simplified_chinese.xml" );
    @unlink( "$mosConfig_absolute_path/mambots/system/jfdatabase.systembot_traditional_chinese.xml" );
