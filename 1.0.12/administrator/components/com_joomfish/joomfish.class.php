...
class JoomFishManager {
	...
	*/
	...
	function getTranslationFooter() {
		return "<a href='http://www.ncc.com.tw/' target='_new'>NCC Software</a> - AlienChen";
	}
...
class translationPublishedFilter extends translationFilter
{
	...
	function _createfilterHTML(){
		...
		$PublishedOptions[] = mosHTML::makeOption( -1, _JOOMFISH_ADMIN_BOTH);
		$PublishedOptions[] = mosHTML::makeOption( 1, _JOOMFISH_ADMIN_PUBLISHED);
		$PublishedOptions[] = mosHTML::makeOption( 0, _JOOMFISH_ADMIN_UNPUBLISHED);
