...
define('_COM_SEF_SH_USE_DEFAULT_ITEMIDS', 'Insérer Itemid par défaut si aucun');
define('_COM_SEF_TT_SH_USE_DEFAULT_ITEMIDS', 'Si activé, lorsqu&rsquo;une URL non-sef ne comporte pas d&rsquo;Itemid, sh404SEF essaiera d&rsquo;utiliser l&rsquo;Itemid par défaut que vous pouvez entrer dans l&rsquo;onglet <b>Par composant</b>.');
define('_COM_SEF_SH_ADV_COMP_DEFAULT_ITEMID', 'Itemid par défaut');
define('_COM_SEF_TT_SH_ADV_COMP_DEFAULT_ITEMID', 'Si l&rsquo;option <b>Insérer Itemid par défaut si aucun</b> est activée (sur l&rsquo;onglet <b>Avancé</b>), vous pouvez entrez dans cette colonne un Itemid par défaut, qui sera utilisé à chaque fois qu&rsquo;une url produite par Joomla ou une de ses extensions ne comportera pas d&rsquo;Itemid');
