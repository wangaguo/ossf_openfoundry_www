	...
	function show( &$rows, $section, $section_name, &$pageNav, &$lists, $type ) {
		...
		<tr>
			...
			if ( $section == 'content') {
				?>
				<th class="categories">
				<?php echo $_LANG->_( 'Category Manager' ); ?> <small><small>[ <?php echo $_LANG->_( 'Content' ); ?>: <?php echo $_LANG->_( 'All' ); ?> ]</small></small>
				</th>
				<td width="right">
		...
		<tr>
			<td valign="top" width="60%">
				...
				<tr>
					...
					<td colspan="2">
					<input class="text_area" type="text" name="title" value="<?php echo stripslashes( $row->title ); ?>" size="50" maxlength="50" title="<?php echo $_LANG->_( 'tipTitleField' ); ?>" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="2">
					<input class="text_area" type="text" name="name" value="<?php echo stripslashes( $row->name ); ?>" size="50" maxlength="255" title="<?php echo $_LANG->_( 'tipNameField' ); ?>" />
					</td>
				</tr>
				<tr>
					<td>
			...
			<table class="adminform" width="40%">
				...
				<tr>
				<td>
				<?php echo $_LANG->_( 'Menu links available when saved' ); ?>
				</td>
				</tr>
			</table>
			<?php
				...
				if ( $row->section > 0 || $row->section == 'content' ) {
					...
					<tr>
						<th colspan="2">
						<?php echo $_LANG->_( 'MOSImage Directories');?>
						</th>
					<tr>
					<tr>
						<td colspan="2">
