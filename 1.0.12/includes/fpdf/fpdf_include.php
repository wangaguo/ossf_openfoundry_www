<?php
    ...
    */
    ...
    require_once($mosConfig_absolute_path . "/includes/fpdf/chinese.php" );
	//Added by Eddy Chang 20040827
    ...
    class PDF extends PDF_Chinese {
       ...
       //Logo
       //$this->Image('acroread.jpg',10,8,0,0);
        
       //$this->SetFont('Big5-hw','B',15);
       //Move to the right
       //$this->Cell(80);
       //Title
       //$this->Cell(30,10,$mosConfig_sitename,0,0,'C');
       //Line break
       //$this->Line(2,20,208,20);
       //$this->Ln(20);
       }
       ...
       function Footer()
      {
       ...
       //Page number
       //$this->Cell(0,10,'Power by Mambo Open Source          Page '.$this->PageNo().'/{nb}          '.$mosConfig_live_site,0,0,'C');
       //$this->Cell(0,10,'Power by Mambo Open Source',0,0,'L');
       ...
       $this->Cell(0,10,$mosConfig_live_site,0,0,'R');
        ...
        function WriteHTML($html) {
			...
			//hardcode to chage big5 magic words...=="
			
			//$html = big5_messy_str_replace($html);
