...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
	...
	<tr><td colspan="2" class="sectiontableheader"><?php echo ($this->link->link_id) ? $this->_MT_LANG->EDIT_LISTING : 	$this->_MT_LANG->ADD_LISTING; ?></td></tr>
</table>
...
<table width="96%" cellpadding="4" cellspacing="0" border="0" align="center">
	...
	<tr>
		<td align="right" valign="middle"><?php echo $this->_MT_LANG->CHANGE_CATEGORY ?>:</td>
