...
<p>
<input name="email" size="11" value="<?php echo _CMN_EMAIL ; ?>" type="text"onblur="if(this.value=='') this.value='<?php echo _CMN_EMAIL ; ?>';" onfocus="if(this.value=='<?php echo _CMN_EMAIL ; ?>') this.value='';"/>
