...
define( '_SYSERR1', 'The database adapter is not available' );//new in 1.0.12
define( '_SYSERR2', 'Could not connect to the database server' );//new in 1.0.12
define( '_SYSERR3', 'Could not connect to the database' );//new in 1.0.12
...
DEFINE('_SUBMIT_BUTTON','Submit');//new in 1.0.12
...
DEFINE('_REG_ACTIVATE_FAILURE', '<div class="componentheading">Activation Failed!</div><br />The system was unable to activate your account, please contact the site administrator.');//new in 1.0.12
...
/** modules/mod_banners */
DEFINE('_BANNER_ALT','Advertisement');//new in 1.0.12
