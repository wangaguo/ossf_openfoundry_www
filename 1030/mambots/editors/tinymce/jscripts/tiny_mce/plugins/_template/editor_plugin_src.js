...
tinyMCE.importPluginLanguagePack('template', 'en,cn,tw,tr,he,nb,ru,ru_KOI8-R,ru_UTF-8,nn,fi,cy,es,is,pl'); // <- Add a comma separated list of all supported languages
