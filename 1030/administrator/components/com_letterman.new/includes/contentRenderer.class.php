...
class lm_contentRenderer {
	...
	function getContent( $nl_content) {
		...
		**/
		...
		$content['html_message'] = '<table width="100%" border="0" cellpadding="0" cellspacing="0" name="catalo        gue" bgcolor="#EAEAEA">'
	        .'<tr>' 
        	.' <td height="28" colspan="2" valign="top" background="http://www.openfoundry.org/images/newsletter/cal-bg.gif"><img src="http://www.openfoundry.org/images/newsletter/catl.gif" width="179" height="28"></td>'
       		.'</tr>'
	        .'<tr>' 
          	.'  <td >&nbsp;</td>'
       		.'</tr>';
