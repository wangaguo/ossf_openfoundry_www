	...
	?>
		...
		<tr>
			...
			?>
			 ...
			 <td valign="top">
			<?php echo $_LANG->_( '* This will' ); ?> <strong><font color="#FF0000"><?php echo $_LANG->_( 'Permanently Delete' ); ?></font></strong> <br /><?php echo $_LANG->_( 'these Items from the Database *' ); ?>
			<br /><br /><br />
			<div style="border: 1px dotted gray; width: 70px; padding: 10px; margin-left: 50px;">
			<a class="toolbar" href="javascript:if (confirm('<?php echo $_LANG->_( 'AREYOUSUREYOUWANTTODELETED' ); ?>')){ submitbutton('delete');}" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('remove','','images/delete_f2.png',1);">
	...
	?>
		...
		<tr>
			...
			?>
			 ...
			 <td valign="top">
			<?php echo $_LANG->_( '* This will' ); ?> <strong><font color="#FF0000"><?php echo $_LANG->_( 'Restore' ); ?></font></strong> <?php echo $_LANG->_( 'these Items' ); ?>,<br /><?php echo $_LANG->_( 'THEYWILLBERETURNED' ); ?>
			<br /><br /><br />
			<div style="border: 1px dotted gray; width: 80px; padding: 10px; margin-left: 50px;">
			<a class="toolbar" href="javascript:if (confirm('<?php echo $_LANG->_( 'AREYOUSUREYOUWANTTORESTORE' ); ?>')){ submitbutton('restore');}" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('restore','','images/restore_f2.png',1);">
