...
class content_section_menu_html {
	...
	function editSection( &$menu, &$lists, &$params, $option ) {
		...
		<tr>
			<th>
			<?php echo $menu->id ? $_LANG->_( 'Edit' ) : $_LANG->_( 'Add' );?> <?php echo $_LANG->_( 'Menu Item :: List - Content Section' ); ?>
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					...
					<?php
					if ( !$menu->id ) {
						echo mosToolTip( $_LANG->_( 'TIPIFLEAVEBLANKSECTIONNAMEWILLAUTOUSED' ) );
					}
					?>
					</td>
				</tr>
				<tr>
					<td align="right" valign="top"><?php echo $_LANG->_( 'Section' ); ?>:</td>
					<td colspan="2">
