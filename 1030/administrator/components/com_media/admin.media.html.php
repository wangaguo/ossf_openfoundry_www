					...
					<tr>
						<td>
							...
							<tr>
								...
								<td align="right">
									<?php echo $_LANG->_( 'File Upload' ); ?> <small>[ Max = <?php echo ini_get( 'post_max_size' );?> ]</small>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div style="float:left; padding: 5px">
			...
			<div class="imginfoBorder">
				...
				<div class="buttonOut">
					...
					<a href="#" onclick="javascript:window.top.document.forms[0].imagecode.value = '<img src=&quot;<?php echo $img_url;?>&quot; align=&quot;left&quot; hspace=&quot;6&quot; alt=&quot;Image&quot; />';" title=<?php echo $_LANG->_("Image Code");?>>
