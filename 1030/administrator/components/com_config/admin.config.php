...
$session = array(
		mosHTML::makeOption( 0, $_LANG->_('Level 3 Security- Default & Highest') ),
		mosHTML::makeOption( 1, $_LANG->_('Level 2 Security - Allow for proxy IPs') ),
		mosHTML::makeOption( 2, $_LANG->_('Level 1 Security - Backward Compatibility') )
	);
...
// LOCALE SETTINGS
	...
	$timeoffset = array(	
		...
		mosHTML::makeOption( 8, '(UTC +08:00) Beijing, Perth, Singapore, Hong Kong, Taipei'),
