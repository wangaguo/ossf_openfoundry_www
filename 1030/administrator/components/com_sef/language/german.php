...
define('_COM_SEF_DISABLED',							'Hinweis: Die SEF Unterstützung in diesem CMS ist momentan deaktiviert. Um SEF zu benutzen, muss in der <a href="' . $GLOBALS['mosConfig_live_site'] .'/administrator/index2.php?option=com_config">Systemsteuerung</a> unter dem TAB SEO die SEF-Urls aktiviert werden' );
...
define('_COM_SEF_TT_SH_REMOVE_JOOMLA_GENERATOR',	'Wenn <strong>Ja</strong> wird der &quot;Generator = CMS-Name&quot; Meta Tag entfernt wenn das shCustomTags Modul veröffentlicht ist');
