...
class HTML_joomfish {
	...
	<tr align="center" valign="middle">
      <td align="left" valign="top" width="70%">
		<h2><?php echo _JOOMLAFISH_PREAMBLE; ?></h2>
		<?php echo _JOOMLAFISH_PREAMBLEDESC; ?>
		
					<?php
			switch ( $fileCode ) {
				case "changelog":
					?>
					<h2><?php echo _JOOMFISH_CHANGELOG; ?></h2>
					<?php
				...
				case "license":
					?>
					<h2><?php echo _JOOMFISH_THINK_NETWORK; ?></h2>
					<?php
				...
				default:
					?>
					<h2><?php echo _JOOMFISH_README; ?></h2>
					<?php
...
<?php } ?>
	...
	function showUpgradeInstall( $joomFishManager, $upgradeSucessful, $upgradeDone, $lists ) {
		...
		<tr>
			...
			<td>
				...
				<?php echo ($summary['jf_languages_copied'] ? _JOOMFISH_COPY_SUCESSFUL : _JOOMFISH_COYP_FAILURE);?>
			</td>
			<td>
  ...
  function _sideMenu() {
  	...
  	?>
		...
		<p><span class="contentheading"><?php echo _JOOMFISH_RELATED_TOPICS; ?> :</span>
		<ul>
			<li><a href="index2.php?option=com_joomfish&amp;act=credits"><?php echo _JOOMFISH_HELP; ?></a></li>
			<li><a href="index2.php?option=com_joomfish&amp;act=dinnermenu"><?php echo _JOOMFISH_MENU_DOC; ?></a></li>
			<li><a href="http://www.joomfish.net" target="_blank"><?php echo _JOOMFISH_OFFICIAL_PROJECT_WEBSITE; ?></a></li>
			<li><a href="http://forge.joomla.org/sf/discussion/do/listForums/projects.joomfish/discussion" target="_blank"><?php echo _JOOMFISH_OFFICIAL_PROJECT_FORUM; ?></a></li>
			<li><a href="http://forge.joomla.org/sf/tracker/do/listArtifacts/projects.joomfish/tracker.bugs" target="_blank"><?php echo _JOOMFISH_BUHTRACKER; ?></a></li>
		</ul>
		</p>
		<p><span class="contentheading">><?php echo _JOOMFISH_DOCANDTUTORY; ?> :</span>
		<ul>
			<li><a href="http://forge.joomla.org/sf/wiki/do/viewPage/projects.joomfish/wiki/HomePage" target="_blank"><?php echo _JOOMFISH_PROJECT_DOC_SITE; ?></a></li>
			<li><a href="index2.php?option=com_joomfish&amp;act=showInformation&amp;fileCode=readme"><?php echo _JOOMFISH_INSTALLATION; ?></a></li>
			<li><a href="index2.php?option=com_joomfish&amp;act=showInformation&amp;fileCode=changelog"><?php echo _JOOMFISH_CHANGELOG; ?></a></li>
			<li><a href="http://www.joomfish.net" target="_blank"><?php echo _JOOMFISH_OFFICIAL_PROJECT_WEBSITE; ?></a></li>
			<li><a href="http://forge.joomla.org/sf/discussion/do/listForums/projects.joomfish/discussion" target="_blank"><?php echo _JOOMFISH_OFFICIAL_PROJECT_FORUM; ?></a></li>
			<li><a href="http://forge.joomla.org/sf/tracker/do/listArtifacts/projects.joomfish/tracker.bugs" target="_blank"><?php echo _JOOMFISH_BUHTRACKER; ?></a></li>
		</ul>
		</p>
		<p><span class="contentheading"><?php echo _JOOMFISH_LICENSE; ?> :</span>
		<ul>
			<li><a href="index2.php?option=com_joomfish&amp;act=showInformation&amp;fileCode=license"><?php echo _JOOMFISH_THINK_NETWORK; ?></a></li>
		</ul>
		</p>
		<p><span class="contentheading"><?php echo _JOOMFISH_ADDITIONAL_SITES; ?> :</span>
		<ul>
  ...
  function _openAdminForm() {
	...
	function _creditsCopyright() {
		?>
		<p>
		<span class="smallgrey"><strong><?php echo _JOOMFISH_ADMIN_CREDITS; ?> :</strong></span><br />
		<span class="smallgrey"><?php echo _JOOMFISH_PRESENT; ?>
		<ul>
		...
		&nbsp;<br />
		<?php echo _JOOMFISH_SPECIAL_THANKS; ?>:<br />
