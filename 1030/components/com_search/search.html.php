	...
	function searchbox( $searchword, &$lists, $params ) {
		...
		<table class="contentpaneopen<?php echo $params->get( 'pageclass_sfx' ); ?>">
			<tr>
				...
				<td nowrap="nowrap">
					<input type="text" name="searchword" id="search_searchword" size="30" maxlength="50" value="<?php echo stripslashes($searchword);?>" class="inputbox" /><!--Modify by ally change maxlength up to 50 2008/01/09-->
				</td>
