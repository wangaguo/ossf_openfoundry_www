...
<table width="96%" cellpadding="4" cellspacing="0" border="0" align="center">
	...
	<?php endif; ?>
	<tr>
		<td valign="top" align="right"><?php echo $this->_MT_LANG->PRICE ?>:</td>
		<td align="left"><input class="inputbox" type="text" name="price" value="<?php echo $this->link->price ?>" size="10" /></td>
	</tr>
	<tr>
