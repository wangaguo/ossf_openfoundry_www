...
class HTML_content {
	...
	*/
	function editContent( &$row, $section, &$lists, &$images, &$access, $myid, $sectionid, $task, $Itemid ) {
		...
		<?php 
			//200704-25 Eddy: Add Calendar language for language file
			global $mosConfig_lang;
		if($mosConfig_lang=='traditional_chinese'){
			echo '<script language="javascript" type="text/javascript" src="'.$mosConfig_live_site.'/includes/js/calendar/lang/calendar-tw.js"></script>';
		}else if($mosConfig_lang=='simplified_chinese'){
			echo '<script language="javascript" type="text/javascript" src="'.$mosConfig_live_site.'/includes/js/calendar/lang/calendar-cn.js"></script>';
		}else{ 
		echo '<script language="javascript" type="text/javascript" src="'.$mosConfig_live_site.'/includes/js/calendar/lang/calendar-en.js"></script>';
		}
		//Eddy: end
		?>	
