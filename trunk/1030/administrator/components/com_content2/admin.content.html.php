	...
	*/
	function showContent( &$rows, $section, &$lists, $search, $pageNav, $all=NULL, $redirect ) {
		...
		<tr>
			...
			if ( $all ) {
				?>
				<?php echo $_LANG->_( 'Content Items Manager' ); ?> <small><small>[ <?php echo $_LANG->_( 'Section' ); ?>: <?php echo $_LANG->_( 'All' ); ?> ]</small></small>
				<?php
			} else {
				?>
				<?php echo $_LANG->_( 'Content Items Manager' ); ?> <small><small>[ <?php echo $_LANG->_( 'Section' ); ?>: <?php echo $section->title; ?> ]</small></small>
				<?php
			}
			?>
			</th>
	...
	*/
	function showArchive( &$rows, $section, &$lists, $search, $pageNav, $option, $all=NULL, $redirect ) {
		...
		<tr>
			...
			if ( $all ) {
				?>
				<?php echo $_LANG->_( 'Archive Manager' ); ?> <small><small>[ <?php echo $_LANG->_( 'Section' ); ?>: <?php echo $_LANG->_( 'All' ); ?> ]</small></small>
				<?php
			} else {
				?>
				<?php echo $_LANG->_( 'Archive Manager' ); ?> <small><small>[ <?php echo $_LANG->_( 'Section' ); ?>: <?php echo $section->title; ?> ]</small></small>
				<?php
			}
			?>
			</th>
	...
	function editContent( &$row, $section, &$lists, &$sectioncategories, &$images, &$params, $option, $redirect, &$menus ) {
		...
		<tr>
			...
			<td valign="top" width="40%">
					...
					$tabs->startTab($_LANG->_( 'Publishing' ),"publish-page");
					?>
					...
					<?php
					$tabs->endTab();
					$tabs->startTab($_LANG->_( 'Images' ),"images-page");
					?>
					...
					<?php
					$tabs->endTab();
					$tabs->startTab($_LANG->_( 'Parameters' ),"params-page");
					?>
					<table class="adminform">
					<tr>
						<th colspan="2">
					...
					<?php
					$tabs->endTab();
					$tabs->startTab($_LANG->_( 'Meta Info' ),"metadata-page");
					?>
					<table class="adminform">
					<tr>
						<th colspan="2">
					...
					<?php
					$tabs->endTab();
					$tabs->startTab($_LANG->_( 'Link to Menu' ),"link-page");
					?>
					<table class="adminform">
					<tr>
						<th colspan="2">
