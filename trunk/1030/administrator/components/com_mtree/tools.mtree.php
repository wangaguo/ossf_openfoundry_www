...
function generate_random_listings( $quantity=100 ) {
	...
	include_once( $mosConfig_absolute_path . '/components/com_mtree/nonsense/nonsense.php' );
	$non = new Nonsense();
	...
	for ($i=0; $i<$quantity; $i++) {
		...
		$sql = "INSERT INTO `mos_mt_links` (`link_name`, `link_desc`, `user_id`, `link_hits`, `link_votes`, `link_rating`, `link_featured`, `link_image`, `link_published`, `link_approved`, `link_template`, `attribs`, `metakey`, `metadesc`, `internal_notes`, `ordering`, `link_created`, `publish_up`, `publish_down`, `link_modified`, `address`, `city`, `state`, `country`, `postcode`, `telephone`, `fax`, `email`, `website`, `price`, `cust_1`, `cust_2`, `cust_3`, `cust_4`, `cust_5`, `cust_6`, `cust_7`, `cust_8`, `cust_9`, `cust_10`) "
