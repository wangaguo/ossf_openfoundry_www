...
if( !defined( 'JOOMAP_LANG' )) {
    ...
    // -- Tips ---------------------------------------------------------------------
    define('_JOOMAP_EXCLUDE_MENU_TIP',		'Add meg a helytérképbõl kihagyandó menüazonosítókat.<br /><strong>MEGJEGYZÉS</strong><br />Válaszd el vesszõvel az azoosítókat!');
    define('_JOOMAP_CFG_GOOGLE_MAP_TIP',	'A GoogleSiteMap számára generált XML fájl');
    define('_JOOMAP_GOOGLE_LINK_TIP',		'Másold ki a hivatkozást és küldd be a GoogleSiteMap-nek');

    // -- Menus --------------------------------------------------------------------
    define("_JOOMAP_CFG_SET_ORDER", "Határozd meg a menük megjelenítésének sorrendjét");
    ...
    define("_JOOMAP_CFG_DISABLE", "Kattints rá a letiltáshoz");
    define("_JOOMAP_CFG_ENABLE", "Kattints rá az engedélyezéshez");
