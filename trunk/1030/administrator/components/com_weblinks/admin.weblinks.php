...
function editWeblink( $option, $id ) {
	...
	if($mosConfig_lang!='english')
		$file=$mosConfig_absolute_path .'/administrator/components/com_weblinks/weblinks_item_'.$mosConfig_lang.'.xml';
...
function saveWeblink( $option ) {
	...
	//Eddy 20070207:protect description string
	global $mosConfig_absolute_path;
	require_once($mosConfig_absolute_path.'/includes/utf8.php');
	$row->description=utf8_substr($row->description,0,100);
	//End
