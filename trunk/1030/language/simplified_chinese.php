...
/*
 /**
* Support site : http://www.joomla.org.tw/
* Translators : Eddy Chang (eddy@joomla.com.tw) & DOFI(dofilab@seed.net.tw)
* Version : for Joomla! 1.0.12
* Last Update: 2007/01/07
* Note :  The orginal translators are genous and lang3(http：//www.mambochina.net) 2005/02/18  
*/
...
// common
DEFINE('_LANGUAGE','cn');
DEFINE("_NOT_AUTH","您并没有检视此网页的权限。");
DEFINE("_DO_LOGIN","请先登录.");
...
DEFINE('_LOGIN_INCOMPLETE','请填写用户名和密码框.');
DEFINE('_LOGIN_BLOCKED','您的登录被封锁.请联系管理员.');
...
DEFINE('_CLOAKING','此邮件地址受阻挡spam的自动程序保护，需要激活Javascript功能才能查阅。');
...
*/
DEFINE('_GUEST_COUNT','%s 位访客');
DEFINE('_GUESTS_COUNT','%s 位访客');
DEFINE('_MEMBER_COUNT','%s 位会员');
DEFINE('_MEMBERS_COUNT','%s 位会员');
...
DEFINE('_PDF_GENERATED','创建者是:');//1.0.4
...
//new in 1.0.9
DEFINE('_VALID_AZ09_USER','请输入合法的 %s。只能包含0-9 a-z A-Z，需超过 %d 个字元');
DEFINE('_CMN_APPLY','应用');
DEFINE('_STATIC_CONTENT','静态内容');
DEFINE('_CONTACT_MORE_THAN','您不能输入超过一个email住址');
DEFINE('_CONTACT_ONE_EMAIL','您不能输入超过一个email住址');
DEFINE('_E_NO_IMAGE','无图片');
DEFINE('_E_CAPTION_POSITION','标题位置');
DEFINE('_E_CAPTION_ALIGN','标题对齐');
DEFINE('_E_CAPTION_WIDTH','标题宽度');
DEFINE('_KEY_NOT_FOUND','找不到关键字');
DEFINE('_NO_IMAGES','无图片');

//new in 1.0.12
DEFINE('_BANNER_ALT','广告');
define( '_SYSERR1', '数据库连结驱动程式目前无法提供' );
define( '_SYSERR2', '无法连接数据库伺服器' );
define( '_SYSERR3', '无法连接数据库' );
DEFINE('_INSTALL_3PD_WARN','警告：安装协力厂商扩充套件有可能会影响您主机的安全性。升级您安装的Joomla!主系统并不会升级到您所安装的扩充套件。<br />想要了解更多有关于维持您网站安全性的信息，请至访问以下链接 <a href="http://forum.joomla.org/index.php/board,267.0.html" target="_blank" style="color: blue; text-decoration: underline;">Joomla!安全社区</a>.');
DEFINE('_SUBMIT_BUTTON','提交');
DEFINE('_REG_ACTIVATE_FAILURE', '<div class="componentheading">激活失败!</div><br />系统目前无法激活您的帐户，请联糸站点管理员。');
?>
