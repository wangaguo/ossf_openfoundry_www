<?php
/**
* @version $Id: announcement.php 462 2007-12-10 00:05:53Z fxstein $
* Fireboard Component
* @package Fireboard
                ...
                <tr>
                    <th>
                        <div class = "fb_title_cover fbm">
                            <span class = "fb_title fbxl"> <?php echo $mosConfig_sitename; ?> <?php echo _ANN_ANNOUNCEMENTS; ?></span>
                        </div>
                    </th>
                </tr>
            </thead>
            ...
            <table class = "fb_blocktable" id = "fb_announcement " border = "0" cellspacing = "0" cellpadding = "0" width="100%">
                <thead>
                    <tr>
                        <th colspan = "6">
                            <div class = "fb_title_cover fbm">
                                <span class = "fb_title fbxl"> <?php echo $mosConfig_sitename; ?> <?php echo _ANN_ANNOUNCEMENTS; ?> | <a href = "<?php echo $addlink;?>"><?php echo _ANN_ADD; ?></a></span>
                            </div>
                        </th>
                    </tr>
                </thead>
...
<?php echo $row->created; ?>
    ...
    if ($do == "doadd") {
        ...
        # Clear any HTML
        $query1 = "INSERT INTO #__fb_announcement VALUES ('', '$title', '$sdescription', '$description', '" . _CURRENT_SERVER_TIME . "', '$published', '$ordering','$showdate')";
...
<table class = "fb_blocktable" id = "fb_announcement " border = "0" cellspacing = "0" cellpadding = "0" width="100%">
    <thead>
        <tr>
            <th>
                <div class = "fb_title_cover fbm">
                    <span class = "fb_title fbxl"> <?php echo _ANN_ANNOUNCEMENTS; ?>: <?php echo _ANN_ADD; ?> | <a href = "<?php echo $showlink;?>"><?php echo _ANN_CPANEL; ?></a></span>
                </div>
            </th>
        </tr>
    </thead>
...
<table class = "fb_blocktable" id = "fb_announcement " border = "0" cellspacing = "0" cellpadding = "0" width="100%">
    <thead>
        <tr>
            <th>
                <div class = "fb_title_cover fbm">
                    <span class = "fb_title fbxl"> <?php echo _ANN_ANNOUNCEMENTS; ?>: <?php echo _ANN_EDIT; ?> | <a href = "<?php echo $showlink;?>"><?php echo _ANN_CPANEL; ?></a></span>
                </div>
            </th>
        </tr>
    </thead>
