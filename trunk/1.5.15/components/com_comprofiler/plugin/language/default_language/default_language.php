...
DEFINE('_UE_ACCOUNT_JOBTITLE','Username & job title');
...
DEFINE('_UE_PROFESSIONALSKILLS','Professional skills');
DEFINE('_UE_EDUCATION','Education');
DEFINE('_UE_LANGUAGE','Languages');
DEFINE('_UE_INTERESTS','Interests');
DEFINE('_UE_PUBLISHEDBOOK','Published books');
DEFINE('_UE_WORKEXPERIENCE','Work Experience');
DEFINE('_UE_AWARDS','Awards');
DEFINE('_UE_SPEECH','Speech');
