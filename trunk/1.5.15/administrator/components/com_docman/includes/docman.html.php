 ...
 * @version $Id: docman.html.php 803 2009-02-13 14:58:45Z mathias $
 * @package DOCman_1.4
...
class HTML_DMDocman
{
            ...
            <tr>
                <td width="55%" valign="top">
                    ...
                    <?php
                        ...
                        $link = "index2.php?option=com_docman&amp;task=donate";
                        HTML_DMDocman::_quickiconButton( $link, 'dm_donate_48.png', _DML_DONATE, _DM_ICONPATH);
    ...
    function showCredits( $changelog )
    {
		...
		<tr>
            ...
            <td>
            <a href="http://www.joomlatools.eu" target="_blank">
