...
<table width="95%" border="0" cellpadding="0" cellspacing="0">
	<tr valign="top" align="left">
		...
		<span class="copyright">&copy; 2006-2009 smart (<a href="http://www.joomlatune.ru" target="_blank">JoomlaTune.ru</a> | <a href="http://www.joomlatune.com" target="_blank">JoomlaTune.com</a>). <?php echo JText::_('All rights reserved!');?><br /></span></td>
	</tr>
	<tr valign="top" align="left">
		<td>&nbsp;</td>
		<td>&nbsp;</td>
...
<?php
	if (JCOMMENTS_JVERSION == '1.0') {
		...
		foreach($files as $file) {
			if (!preg_match('/[a-z]{2}-[A-Z]{2}\.com_jcomments/', $file)) {
				@unlink($file);
			}
		}
	}
