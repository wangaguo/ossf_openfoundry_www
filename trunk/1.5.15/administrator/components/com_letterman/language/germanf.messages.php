...
define( 'LM_CONFIRM_UNSUBSCRIBE', 'Wollen Sie sich wirklich vom Newsletter abmelden?');
/**
...
define( 'LM_ATTACHMENTS_TOOLTIP', 'Es k&ouml;nnen ein oder mehrere Anh&auml;nge aus dem Verzeichnis %s ausgew&auml;hlt werden. Die Dateien werden beim Versenden der Email in diese eingebettet. Der Platzhalter [ATTACHMENT ..] sollte unverändert gelassen werden - er wird beim Versenden eh ausgeschnitten!' );
