...
<td width="10%" align="center"><a href="#clear" onclick="if (alertClear()) {return listItemTask('cb<?php echo $i;?>','clear')}"><img src="components/com_pollxt/delete.gif" width="12" height="12" border="0" alt="" /></a></td>
...
function editPoll( $mypoll, $questions, $options, $menulist, $conf, $images, $option, $lists, $tab, $plugin) {
		...
		// allow HTML in thank you and intro text
		$ex = array('mypoll[intro]', 'mypoll[thanks]');
		JFilterOutput::objectHTMLSafe( $mypoll, ENT_QUOTES, $ex );
...
?>
    ...
    <table cellpadding="2" cellspacing="4" border="0" width="100%" class="adminform">
      ...
      <tr>
        <td width="120" valign="top"><strong><?php echo JText::_('ADMIN_GS_TOOLTIPS'); ?></strong></td>
        <td valign="top">
	       	<?php echo xtYesNo($config["tooltips"], "config[tooltips]", $config["tooltips"]); ?>
        </td>
        <td valign="top"><?php echo JText::_('ADMIN_GS_TOOLTIPS_HELP'); ?></td>
      </tr>
