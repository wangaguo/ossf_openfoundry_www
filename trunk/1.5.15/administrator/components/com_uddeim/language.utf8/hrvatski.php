...
DEFINE ('_UDDEADM_ENABLEATTACHMENT_HEAD', 'Ukljuèi datoteke privitka');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_EXP', 'Ovo omoguæava svim registriranim korisnicima ili samo administratorima da šalju datoteke u privitku poruka.');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_HEAD', 'Max. velièina datoteke');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_EXP', 'Max. dozvoljena velièina datoteke u privitku.');
DEFINE ('_UDDEIM_FILESIZE_EXCEEDED', 'Premašena je max. dozvoljena velièina datoteke');
...
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_MANUALLY', 'ruèno');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', 'Automatsko brisanje može uzrokovati veliko optereæenje servera. Ako odaberete <b>samo administratori</b>, automatsko brisanje pokreæe se kad administrator provjerava svoju ulaznu poštu. Odaberite ovu opciju ako administrator redovno provjerava ulaznu poštu. Mali ili rijetko administrirani sajtovi mogu odabrati opciju <b>bilo koji korisnik</b>.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', 'Oèisti datoteke');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', 'Dozovi brisanje datoteke');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', 'Uklanja izbrisane datoteke iz baze podataka. Ovo je isto kao i na kartici \'Oèisti datoteke\'.');
...
DEFINE ('_UDDEADM_RESTORE_DONE', 'Završeno je vraæanje konfiguracije.');
DEFINE ('_UDDEADM_PRUNE_DONE', 'Završeno je èišæenje poruka.');
DEFINE ('_UDDEADM_FILEPRUNE_DONE', 'Završeno je èišæenje datoteka iz privitka.');
...
DEFINE ('_UDDEADM_SHOWMENUCOUNT_HEAD', 'Prikaži brojaèe');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', 'Kad je odabrano <b>da</b>, izbornièka traka sadrži brojaè poruka. Napomena: Ovo zahtijeva više dodatnih upita u bazi podataka pa stoga ne koristite na slabijim sustavima.');
...
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>Nemate neproèitanih poruka od ovog korisnika u%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>Nemate neproèitanih poruka od ovog korisnika u%s.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '\'Email stop\' ukljuèeno.');
DEFINE ('_UDDEIM_ACCOUNTLOCKED', 'Pristup vašoj ulaznoj pošti je zakljuèan. Kontaktirajte administratora stranica.');
DEFINE ('_UDDEADM_USERSET_LOCKED', 'Zakljuèano');
DEFINE ('_UDDEADM_USERSET_SELLOCKED', '- Zakljuèano -');
DEFINE ('_UDDEADM_CBBANNED_HEAD', 'Provjera zabranjenih CB korisnika');
DEFINE ('_UDDEADM_CBBANNED_EXP', 'Kad je ukljuèeno, aktivira se uddeIM provjera da li je korisnik zabranjen u CB, te mu se zabranjuje pristup u uddeIM. Osim toga, drugi korisnici ne mogu slati poruke zabranjenom korisniku.');
...
DEFINE ('_UDDEADM_REPORTSPAM_EXP', 'Kad je ukljuèeno prikazuje link \'Prijavi poruku\' koji omoguæava korisnicima da administratoru prijave SPAM.');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESPAM', 'Izbriši poruku');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEREPORT', 'Izbriši izvješæe');
DEFINE ('_UDDEIM_TOOLBAR_SPAMCONTROL', 'Kontrola izvješæa');
...
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEREMOVE', 'Izbrisati ovo izvješæe?');
DEFINE ('_UDDEADM_SPAMCONTROL_SHOWHIDE', 'Prikazati/Sakriti');
DEFINE ('_UDDEADM_SPAMCONTROL_EDIT', 'Kontrolni centar izvješæa');
...
DEFINE ('_UDDEIM_SPAMCONTROL_UNREPORT', 'Opozovi ovo izvješæe');
...
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', 'Kad je ukljuèeno, ovo æe postaviti kuæicu za oznaèavanje pored dugmeta \'Pošalji\' koja æe se zvati \'poruka u smeæe\' , ova kuæica nije automatski oznaèena. Korisnici mogu oznaèiti kuæicu ako žele izbrisati poslanu poruku odmah nakon njenog slanja.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'poruka u smeæe');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_4', '...odreðivanje standardnih postavki za brisanje poslanih poruka, prijavljivanje spama, CB korisnike pod zabranom');
...
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "uddeIM korisiti dvije XML datoteke kako bi osigurao da se zip datoteke mogu instalirati na Joomla 1.0 i 1.5. U Joomla 1.5, jedna XML datoteka nije potrebna te ovo prisiljava Menadžera Ekstenzija da prikaže netoènu obavijest o nekompatibilnosti. Ovo briše nepotrebne datoteke kako se upozorenje ne bi više prikazivalo.");
...
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Ovo æe biti uèinjeno za slijedeæe zapakirane datoteke:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Nepotrebni XML instaleri za slijedeæe uddeIM zip datoteke bit æe izbrisani:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "Nije pronaðen nijedan nepotreban XML instaler za uddeIM zip datoteke!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', 'Izgled izbornièke trake');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', 'Ovdje možete odrediti da li æe se izbornièka traka prikazivati s ikonama i/ili tekstom.');
...
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', 'Ukljuèi kompletnu poruku u email obavijest.');
...
DEFINE ('_UDDEIM_LISTGLOBAL_RESTRICTED', 'Ogranièeno');
DEFINE ('_UDDEIM_LISTGLOBAL_P0', 'Normalna lista kontakata');
DEFINE ('_UDDEIM_LISTGLOBAL_P1', 'Globalna lista kontakata');
DEFINE ('_UDDEIM_LISTGLOBAL_P2', 'Ogranièena lista kontakata (Izlistaj samo èlanove koji mogu pristupiti listi)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', 'Korisnièke postavke');
...
DEFINE ('_UDDEIM_TOOLBAR_TRASHMSGS', 'Poruka za smeæe');
...
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', 'Djelomièni uvoz poruka iz starog PMS-a gotov. Nemojte ponovno uvoziti ovaj dio jer æe te zbog toga ponovno uvesti iste poruke i imati njihove duplikate.');
...
DEFINE ('_UDDEADM_IMPORT_PARTIAL', 'Djelomièan uvoz:');
DEFINE ('_UDDEADM_UPDATEYOURDB', 'Važno: Niste ažurirali vašu bazu podataka! Molimo vas da proèitate README kako bi ispravno ažurirali uddeIM!');
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', 'Ogranièi pristup svim korisnicima');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Možete ogranièiti pristup popisu "Svi korisnici". Obièno je popis "Svi korisnici" dostupan svima (<i>bez ogranièenja</i>).');
DEFINE ('_UDDEADM_RESTRALLUSERS_0', 'bez ogranièenja');
...
DEFINE ('_UDDEIM_HELP', 'Pomoæ');
DEFINE ('_UDDEIM_HELP_HEADLINE1', 'uddeIM Pomoæ');
...
DEFINE ('_UDDEIM_HELP_TRASHCAN', '<b>Smeæe</b> sadrži sve izbrisane poruke. Poruke nisu odmah izbrisane veæ se èuvaju neko vrijeme. Poruku možete vratiti sve dok je pohranjena u smeæu.');
...
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>Kontakti</b> omoguæavaju održavanje liste kontakata (poznate i kao distribucijske liste). Ove liste omoguæavaju slanje privatnih poruka za višestruke primatelje. Umjesto dodavanja više primatelja, možete jednostavno upisati <i>#listname</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>Postavke</b> sadrže sve opcije koje se mogu ureðivati.');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>Sastavi</b> dozvoljava kreiranje novih poruka.');
DEFINE ('_UDDEIM_HELP_IREAD', 'Poruka je proèitana (možete izmijeniti status).');
DEFINE ('_UDDEIM_HELP_IUNREAD', 'Poruka nije proèitana (možete izmijeniti status).');
DEFINE ('_UDDEIM_HELP_OREAD', 'Poruka je proèitana.');
DEFINE ('_UDDEIM_HELP_OUNREAD', 'Poruka nije proèitana. Neproèitane poruke mogu se opozvati.');
DEFINE ('_UDDEIM_HELP_TREAD', 'Poruka je proèitana.');
DEFINE ('_UDDEIM_HELP_TUNREAD', 'Poruka nije proèitana.');
DEFINE ('_UDDEIM_HELP_FLAGGED', 'Poruka je oznaèena npr. kad je rijeè o važnoj poruci (možete izmijeniti status).');
...
DEFINE ('_UDDEIM_HELP_DELETE', 'Izbriši poruku (premjesti poruku u smeæe).');
DEFINE ('_UDDEIM_HELP_FORWARD', 'Proslijedi poruku drugom primatelju.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Arhiviraj poruku. Ako je admin odredio vremensko ogranièenje za poruke pohranjene u ulaznoj pošti, arhivirane se poruke neæe automatski brisati.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Dearhiviraj poruku. Poruka æe se vratiti u ulaznu poštu.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Opozovi poruku. Poslane poruke mogu se opozvati ako ih primatelj još nije proèitao.');
DEFINE ('_UDDEIM_HELP_RECYCLE', 'Recikliraj poruku (premjesti poruku iz smeæa u ulaznu ili izlaznu poštu).');
DEFINE ('_UDDEIM_HELP_NOTIFY', 'Konfiguracija email obavijesti o dolasku nove poruke.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'Kad je ukljuèen automatski odgovor, odmah æe se odgovoriti na svaku primljenu poruku.');
...
DEFINE ('_UDDEIM_HELP_MISC', 'Ovdje možete pronaæi dodatne postavke konfiguracije');
...
DEFINE ('_UDDEADM_SEPARATOR_P1', 'toèka i zarez');
DEFINE ('_UDDEADM_RSSLIMIT_HEAD', 'RSS objekti');
DEFINE ('_UDDEADM_RSSLIMIT_EXP', 'Ogranièite broj vraæenih RSS objekata (0 za neogranièeno).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', 'Prikazati dugme za pomoæ');
DEFINE ('_UDDEADM_SHOWHELP_EXP', 'Kad je ukljuèeno, prikazuje se dugme za pomoæ.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', 'Prikazati iGoogle gadget dugme');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', 'Kad je ukljuèeno, u korisnikovim se preferencama prikazuje <i>Dodaj u iGoogle</i> dugme za uddeIM iGoogle gadget.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', 'nemoj uèitati MooTools (koriste se 1.1)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', 'nemoj uèitati MooTools (korite se 1.2)');
DEFINE ('_UDDEIM_RSS_INTRO1', 'Mapi dolazne pošte možete pristupiti koristeæi RSS feed (0.91).');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'Pristupni URL je:');
DEFINE ('_UDDEIM_RSS_INTRO2', 'Ne prosljeðujte ovaj URL ostalim korisnicima jer on dozvoljava pristup vašoj pošti.');
...
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', 'Pogrešno korisnièko ime ili šifra...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', 'Nema poruka');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', 'Nema novih poruka');
DEFINE ('_UDDEADM_ENABLERSS_HEAD', 'Omoguæi RSS');
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Kad je ukljuèena ova opcija, poruke se mogu primati putem RSS feed-a. Korisnici æe u svom profilu pronaæi odgovarajuæi URL.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...odredi standardno za RSS, iGoogle, pomoæ, razdvojnik');
...
DEFINE ('_UDDEIM_PMNAV_EXISTS', 'preskoèi na poruku');
DEFINE ('_UDDEIM_PMNAV_COPY2ME', '(Kopiraj)');
DEFINE ('_UDDEADM_PMNAV_HEAD', 'Dozvoli navigaciju');
DEFINE ('_UDDEADM_PMNAV_EXP', 'Prikazuje navigacijsku traku koja omoguæava navigaciju kroz niz poruka.');
...
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Brojaè:');
...
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', 'samo neproèitane');
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Filter');
DEFINE ('_UDDEIM_FILTER_ALL', '- sve -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- javni korisnici -');
DEFINE ('_UDDEADM_FILTER_HEAD', 'Omoguæi filter');
DEFINE ('_UDDEADM_FILTER_EXP', 'Ako je ukljuèeno, korisnici mogu filtrirati svoju ulaznu i izlaznu poštu kako bi prikazali samo jednog primatelja ili pošiljatelja.');
DEFINE ('_UDDEADM_FILTER_P0', 'iskljuèeno');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' neproèitanih');
...
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', 'Kad je oznaèeno, poruci æe se dodati redak koji sadrži sve primatelje.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '...odredi standardno za automatske odgovore, automatsko proslijeðivanje, filter');
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', 'Ukljuèi automatske odgovore');
DEFINE ('_UDDEADM_AUTORESPONDER_EXP', 'Kad su automatski odgovori ukljuèeni, korisnik može u svojim osobnim postavkama ukljuèiti automatsko odgovaranje.');
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Ukljuèi automatske odgovore');
DEFINE ('_UDDEIM_AUTORESPONDER', 'Automatski odgovori');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Kad su automatski odgovori ukljuèeni, automatski æe se odgovoriti na svaku primljenu poruku.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Nažalost, trenutno nisam dostupan.\nPrvom æu prilikom pregeldati svoju poštu.");
DEFINE ('_UDDEADM_USERSET_AUTOR', 'AutoO');
DEFINE ('_UDDEADM_USERSET_SELAUTOR', '- AutoO -');
DEFINE ('_UDDEIM_USERBLOCKED', 'Korisnik je blokiran.');
DEFINE ('_UDDEADM_AUTOFORWARD_HEAD', 'Omoguæi automatsko proslijeðivanje');
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Kad je ukljuèeno automatsko proslijeðivanje, korisnik može automatski proslijediti nove poruke drugom korisniku.');
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', 'Ukljuèi automatsko proslijeðivanje');
DEFINE ('_UDDEADM_USERSET_AUTOF', 'AutoP');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- AutoP -');
DEFINE ('_UDDEIM_AUTOFORWARD', 'Automatsko proslijeðivanje');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'Nove se poruke mogu automatski proslijediti drugom korisniku.');
DEFINE ('_UDDEIM_THISISAFORWARD', 'Automatsko proslijeðivanje poruke poslane za ');
DEFINE ('_UDDEADM_COLSROWS_HEAD', 'Prostor poruke (stupaca/redaka)');
DEFINE ('_UDDEADM_COLSROWS_EXP', 'Ovo odreðuje broj stupaca i redaka u prostoru za poruke (standardne vrijednosti su 60/10).');
DEFINE ('_UDDEADM_WIDTH_HEAD', 'Prostor poruke (širina)');
DEFINE ('_UDDEADM_WIDTH_EXP', 'Ovo odreðuje širinu prostora za poruku u px (standardno je 0). Ako je ova vrijednost 0, koristi se širina odreðena u CSS stilu.');
...
// New: 1.3
DEFINE ('_UDDEADM_MOOTOOLS_HEAD', 'Uèitaj MooTools');
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'Ovo odreðuje kako uddeIM uèitava MooTools (MooTools su potrebni za Autodovršavanje): <i>Ništa</i> je korisno kad vaš predložak uèitava MooTools, <i>Auto</i> se preporuèa kao standardna postavka (isto ponašanje kao u uddeIM 1.2), kad koristite J1.0 možete takoðer tražiti uèitavanje MooTools 1.1 ili 1.2.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE', 'ne uèitavaj MooTools');
DEFINE ('_UDDEADM_MOOTOOLS_AUTO', 'auto');
DEFINE ('_UDDEADM_MOOTOOLS_1', 'prisilno uèitavanje MooTools-a 1.1');
DEFINE ('_UDDEADM_MOOTOOLS_2', 'prisilno uèitavanje MooTools-a 1.2');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_1', '...poèetne postavke za MooTools');
DEFINE ('_UDDEADM_AGORA', 'Agora');

// New: 1.2
DEFINE ('_UDDEADM_CRYPT3', 'Base64 kodirano');
DEFINE ('_UDDEADM_TIMEZONE_HEAD', 'Podesi vremensku zonu');
DEFINE ('_UDDEADM_TIMEZONE_EXP', 'Kad uddeIM prikazuje pogrešno vrijeme, ovdje možete prilagoditi postavke vremenske zone. Kad je sve konfigurirano kako treba, ova vrijednost obièno treba biti nula. Ali, mogu postojati i sluèajevi u kojima trebate prilagoditi ovu vrijednost.');
...
DEFINE ('_UDDEADM_STATISTICS_EXP', 'Prikazuje stratistièke podatke poput broja pohranjenih poruka, itd.');
DEFINE ('_UDDEADM_STATISTICS_CHECK', 'PRIKAŽI STATISTIKU');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT', 'Poruke spremljene u bazi: ');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT_RECIPIENT', 'Poruke u primateljevom Smeæu: ');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT_SENDER', 'Poruke u pošiljateljevom Smeæu: ');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT_TRASH', 'Poruke koje èekaju èišæenje: ');
DEFINE ('_UDDEADM_OVERWRITEITEMID_HEAD', 'Prepiši Itemid');
DEFINE ('_UDDEADM_OVERWRITEITEMID_EXP', 'uddeIM obièno pokušava otkriti ispravni Itemid. U nekim sluèajevima može biti neophodno da se ova vrijednost prepiše tj. zamijeni, npr. kad koristite nekoliko izbornièkih linkova za uddeIM.');
...
DEFINE ('_UDDEADM_SHOWLINK_EXP', 'Kad je postavljeno na <i>Da</i>, sva æe se korisnièka imena prikazana u uddeIM prikazati kao linkovi za profil korisnika.');
DEFINE ('_UDDEADM_SHOWPIC_HEAD', 'Prikaži miniSlike');
DEFINE ('_UDDEADM_SHOWPIC_EXP', 'Kad je postavljeno na <i>Da</i>, prilikom èitanja poruke prikazivat æe se miniSlika odgovarajuæeg korisnika.');
...
DEFINE ('_UDDEADM_DISABLED', 'Iskljuèeno');
DEFINE ('_UDDEADM_ENABLED', 'Ukljuèeno');
...
DEFINE ('_UDDEADM_ALLOWFLAGGED_EXP', 'Dozvoljava obilježavanje poruka (uddeIM prikazuje zvjezdicu u listama koje mogu biti oznaèene za važne poruke).');
DEFINE ('_UDDEADM_REVIEWUPDATE', 'Važno: Prilikom ažuriranja starije verzije uddeIM proèitajte README datoteku. Naime, ponekad æe te morati dodati ili izmijeniti tablice ili polja u bazi podataka!');
DEFINE ('_UDDEIM_ADDCCINFO', 'Dodaj CC: redak');
DEFINE ('_UDDEIM_CC', 'CC:');
DEFINE ('_UDDEADM_TRUNCATE_HEAD', 'Sažmi citirani tekst');
DEFINE ('_UDDEADM_TRUNCATE_EXP', 'Sažmite citirani tekst na 2/3 maksimalne duljine teksta, ako tekst premašuje ogranièenje.');
...
// New: 1.1
DEFINE ('_UDDEADM_NOTRASHACCESS_NOT', 'Pristup Smeæe nije dozvoljen.');
DEFINE ('_UDDEADM_NOTRASHACCESS_HEAD', 'Ogranièite pristup Smeæu');
DEFINE ('_UDDEADM_NOTRASHACCESS_EXP', 'Možete ogranièiti pristup Smeæu. Obièno je Smeæe dostupno svima (<i>bez ogranièenja</i>). Pristup možete ogranièiti na specijalne korisnike ili samo na administratore tako da grupe korisnika s nižem stupnjem pristupa ne mogu reciklirati poruke.');
DEFINE ('_UDDEADM_NOTRASHACCESS_0', 'Bez ogranièenja');
...
DEFINE ('_UDDEADM_CSRFPROTECTION_EXP', 'Štiti sve obrasce od Cross-Site Request Forgery napada. Ova postavka obièno treba biti ukljuèena. Iskljuèite ju samo ako vam se javljaju neki neobièni problemi.');
...
DEFINE ('_UDDEADM_PUBNAMESDESC', 'Prikazati prava ili korisnièka imena u Frontendu?');
DEFINE ('_UDDEIM_USERLIST', 'Lista korisnika');
DEFINE ('_UDDEIM_YOUHAVETOWAIT', 'Nažalost, morate prièekati na unos nove poruke');
DEFINE ('_UDDEADM_USERSET_LASTSENT', 'Posljednje poslano');
DEFINE ('_UDDEADM_TIMEDELAY_HEAD', 'Vremenska odgoda');
DEFINE ('_UDDEADM_TIMEDELAY_EXP', 'Vrijeme u sekundama koje korisnik mora èekati prije slanja slijedeæe poruke (0 za nepostojanje vremenske odgode).');
...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Ovo kontaktira sajt uddeIM autora kako bi se primila informacija o sadašnjoj uddeIM verziji. Ne šalju se nikakve druge informacije osim informacija o uddeIM verziji koju koristite.');
...
DEFINE ('_UDDEIM_NOSUCHLIST', 'Lista kontakata nije pronaðena!');
...
DEFINE ('_UDDEIM_LISTSNOTENABLED', 'Liste kontakata nisu ukljuèene');
DEFINE ('_UDDEADM_ENABLELISTS_HEAD', 'Ukljuèi liste kontakata');
DEFINE ('_UDDEADM_ENABLELISTS_EXP', 'uddeIM dozvoljava korisnicima da kreiraju liste kontakata. Ove liste mogu se koristiti za slanje poruka višestrukim primateljima. Ako želite koristiti liste kontakata, nemojte zaboraviti ukljuèiti opciju višestrukih primatelja poruka.');
DEFINE ('_UDDEADM_ENABLELISTS_0', 'iskljuèeno');
...
DEFINE ('_UDDEIM_STATUS_READ', 'proèitano');
DEFINE ('_UDDEIM_STATUS_UNREAD', 'neproèitano');
...
DEFINE ('_UDDEADM_CBGALLERY_EXP', 'uddeIM standardno prikazuje samo avatare koje su korisnici uploadirali na server. Kad ukljuèite ovi postavku uddeIM æe prikazivati i slike iz CB galerije avatara.');
DEFINE ('_UDDEADM_UNBLOCKCB_HEAD', 'Odblokiraj CB veze');
DEFINE ('_UDDEADM_UNBLOCKCB_EXP', 'Možete dozvoliti poruke za korisnike kad se registrirani korisnik nalazi na CB listi kontakata primatelja (èak i ako se primatelj nalazi u grupi koja je blokirana). Ova postavka je neovisna od individualnog blokiranja koje sam korisnik ureðuje kad je ta opcija ukljuèena (vidi postavke iznad).');
...
DEFINE ('_UDDEADM_PUBBLOCKGROUPS_EXP', 'Grupe kojima korisnici iz javnosti ne mogu slati poruke. Ova postavka je neovisna od individualnog blokiranja koje sam korisnik ureðuje kad je ta opcija ukljuèena (vidi postavke iznad). Kad blokirate neku grupu, korisnici te grupe u postavkama profila ne mogu vidjeti opciju za ukljuèivanje javnog Frontenda.');
...
DEFINE ('_UDDEADM_PUBHIDEALLUSERS_EXP', 'U javnoj listi svih korisnika možete sakriti odreðene grupe korisnika. Napomena: ovo skriva samo imena, korisnici i dalje mogu primati poruke. Korisnici koji nisu ukljuèili javni Frontend nikad neæe biti izlistani u takvim listama.');
DEFINE ('_UDDEADM_HIDEALLUSERS_HEAD', 'Sakrij iz liste "Svi korisnici"');
DEFINE ('_UDDEADM_HIDEALLUSERS_EXP', 'U listi "Svi korisnici" možete sakriti odreðene grupe. Napomena: ovo skriva samo imena, korisnici i dalje mogu primati poruke.');
...
DEFINE ('_UDDEADM_PUBMODESHOWALLUSERS_EXP', 'Odaberite da li æe se link "Svi korisnici" sakriti ili prikazivati u javnom Frontendu, ili da li æe se uvijek prikazati svi korisnici.');
DEFINE ('_UDDEADM_USERSET_PUBLIC', 'Javno suèelje');
DEFINE ('_UDDEADM_USERSET_SELPUBLIC', '- odaberi javno -');
DEFINE ('_UDDEIM_OPTIONS_F', 'Dozvoli slanje poruka javnim korisnicima');
DEFINE ('_UDDEIM_MSGLIMITREACHED', 'Dosegnuto ogranièenje poruke!');
...
DEFINE ('_UDDEADM_CAPTCHALEN_EXP', 'Odreðuje koliko znakova korisnik mora upisati.');
DEFINE ('_UDDEADM_USECAPTCHA_HEAD', 'Captcha spam zaštita');
DEFINE ('_UDDEADM_USECAPTCHA_EXP', 'Odreðuje tko mora upisati captcha prilikom slanja poruke');
DEFINE ('_UDDEADM_CAPTCHAF0', 'iskljuèeno');
...
DEFINE ('_UDDEADM_PUBFRONTEND_HEAD', 'Omoguæi javno suèelje');
DEFINE ('_UDDEADM_PUBFRONTEND_EXP', 'Kad je ukljuèeno, javni korisnici mogu slati poruke vašim registriranim korisnicima (ovi mogu u svojim osobnim postavkama odrediti da li žele koristiti ovu opciju).');
DEFINE ('_UDDEADM_PUBFRONTENDDEF_HEAD', 'Poèetno javno suèelje');
...
DEFINE ('_UDDEADM_PUBDEF0', 'iskljuèeno');
DEFINE ('_UDDEADM_PUBDEF1', 'ukljuèeno');
DEFINE ('_UDDEIM_WRONGCAPTCHA', 'Pogrešan sigurnosni kod');

// New: 1.0
DEFINE ('_UDDEADM_NONEORUNKNOWN', 'nijedan ili nepoznat');
DEFINE ('_UDDEADM_DONATE', 'Napravite malu donaciju ako vam se sviða uddeIM i želite podržati njegov daljnji razvoj.');
// New: 1.0rc2
DEFINE ('_UDDEADM_BACKUPRESTORE_DATE', 'Konfiguracija pronaðena u bazi: ');
DEFINE ('_UDDEADM_BACKUPRESTORE_HEAD', 'Konfiguracija backup-a i vraæanja');
DEFINE ('_UDDEADM_BACKUPRESTORE_EXP', 'Možete u bazi podataka napraviti backup vaše konfiguracije i vratiti ju kad je to potrebno. Ovo je korisno kad ažurirate uddeIM ili kad želite spremiti odreðenu konfiguraciju u svrhu testiranje.');
DEFINE ('_UDDEADM_BACKUPRESTORE_BACKUP', 'BACKUP');
DEFINE ('_UDDEADM_BACKUPRESTORE_RESTORE', 'VRAÆANJE');
DEFINE ('_UDDEADM_CANCEL', 'Odustani');
// New: 1.0rc1
DEFINE ('_UDDEADM_LANGUAGECHARSET_HEAD', 'Znakovlje jeziène datoteke');
...
DEFINE ('_UDDEADM_LANGUAGECHARSET_DEFAULT', 'poèetno');
DEFINE ('_UDDEIM_READ_INFO_1', 'Proèitane æe poruke ostati u Ulaznoj pošti najviše ');
DEFINE ('_UDDEIM_READ_INFO_2', ' dana prije automatskog brisanja.');
DEFINE ('_UDDEIM_UNREAD_INFO_1', 'Neproèitane æe poruke ostati u Ulaznoj pošti najviše ');
DEFINE ('_UDDEIM_UNREAD_INFO_2', ' dana prije automatskog brisanja.');
DEFINE ('_UDDEIM_SENT_INFO_1', 'Poslane æe poruke ostati u Ulaznoj pošti najviše ');
DEFINE ('_UDDEIM_SENT_INFO_2', ' dana prije automatskog brisanja.');
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_HEAD', 'Prikaži oznaku Ulazne pošte za proèitane poruke');
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_EXP', 'Prikazati obavijest ulazne pošte "Proèitane poruke izbrisat æe se nakon n dana"');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_HEAD', 'Prikaži oznaku Ulazne pošte za neproèitane poruke');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_EXP', 'Prikazati obavijest ulazne pošte "Neproèitane poruke izbrisat æe se nakon n dana"');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_HEAD', 'Prikaži oznaku Izlazne pošte za poslane poruke');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_EXP', 'Prikazati obavijest izlazne pošte "Poslane poruke izbrisat æe se nakon n dana"');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_HEAD', 'Prikaži oznaku Smeæa za obrisane poruke');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_EXP', 'Prikaži oznaku Smeæa "Izbrisane poruke izbrisat æe se nakon n dana"');
DEFINE ('_UDDEADM_DELETESENTAFTER_HEAD', 'Poslane poruke spremljene (dana)');
DEFINE ('_UDDEADM_DELETESENTAFTER_EXP', 'Upišite broj dana nakon kojih æe se <b>poslane</b> poruke automatski izbrisati iz izlazne pošte.');
...
DEFINE ('_UDDEADM_USERSET_EDITSETTINGS', 'Uredi korisnièke postavke');
DEFINE ('_UDDEADM_USERSET_EXISTING', 'postojeæi');
DEFINE ('_UDDEADM_USERSET_NONEXISTING', 'nepostojeæi');
...
DEFINE ('_UDDEADM_USERSET_USERNAME', 'Korisnièko ime');
...
DEFINE ('_UDDEADM_WELCOMEMSG', "Dobrodošli u uddeIM!\n\nUspješno ste instalirali uddeIM.\n\nPokušajte pogledati ovu poruku s razlièitim predlošcima. Možete ih odabrati u uddeIM administraciji.\n\nuddeIM je projekt u razvoju. Ako pronaðete bugove ili slabosti, molim vas da mi pišete o njima kako bi smo zajedno uèinili uddeIM boljim.\n\nSretno i uživajte!");
DEFINE ('_UDDEADM_UDDEINSTCOMPLETE', 'uddeIM instalacija je završena.');
DEFINE ('_UDDEADM_REVIEWSETTINGS', 'Otiðite u administrativno suèelje i provjerite postavke.');
DEFINE ('_UDDEADM_REVIEWLANG', 'Ako koristite CMS s znakovljem koje nije ISO 8859-1, provjerite da li ste prilagodili postavke.');
DEFINE ('_UDDEADM_REVIEWEMAILSTOP', 'Nakon instalacije sav uddeIM email promet (email obavijesti, email podsjetnici) je iskljuèen kako se email poruke ne bi slale dok traje vaše testiranje. Kad završite testiranje ne zaboravite u administrativnom suèelju iskljuèiti opciju "stop email".');
DEFINE ('_UDDEADM_MAXRECIPIENTS_HEAD', 'Maksimalno primatelja');
DEFINE ('_UDDEADM_MAXRECIPIENTS_EXP', 'Max. broj dozvoljenih primatelja po poruci (0=bez ogranièenja)');
DEFINE ('_UDDEIM_TOOMANYRECIPIENTS', 'previše primatelja');
DEFINE ('_UDDEIM_STOPPEDEMAIL', 'Slanje e-mail poruka iskljuèeno.');
DEFINE ('_UDDEADM_SEARCHINSTRING_HEAD', 'Pretraga unutar teksta');
DEFINE ('_UDDEADM_SEARCHINSTRING_EXP', 'Autodovršavaè pretražuje unutar teksta (inaèe pretražuje samo od poèetka)');
DEFINE ('_UDDEADM_MODESHOWALLUSERS_HEAD', 'Ponašanje linka "Svi korisnici"');
DEFINE ('_UDDEADM_MODESHOWALLUSERS_EXP', 'Odaberite da li æe se link "Svi korisnici" sakriti, prikazati ili da li æe uvijek biti prikazani svi korisnici.');
...
DEFINE ('_UDDEADM_CONFIGNOTWRITEABLE', 'Konfiguracija nije spremna za ureðivanje:');
DEFINE ('_UDDEADM_CONFIGWRITEABLE', 'Konfiguracija spremna za ureðivanje:');
DEFINE ('_UDDEIM_FORWARDLINK', 'naprijed');
DEFINE ('_UDDEIM_RECIPIENTFOUND', 'primatelj pronaðen');
DEFINE ('_UDDEIM_RECIPIENTSFOUND', 'primatelji pronaðeni');
...
DEFINE ('_UDDEADM_SHOWGROUPS_EXP', 'Prikazati Joomla grupe u opæem popisu poruka.');
DEFINE ('_UDDEADM_ALLOWFORWARDS_HEAD', 'Proslijeðivanje poruka');
DEFINE ('_UDDEADM_ALLOWFORWARDS_EXP', 'Dozvolite proslijeðivanje poruka.');
DEFINE ('_UDDEIM_FWDFROM', 'Originalna poruka od');
DEFINE ('_UDDEIM_FWDTO', 'za');

// New: 0.9+
DEFINE ('_UDDEIM_UNARCHIVE', 'Dearhivirana poruka');
DEFINE ('_UDDEIM_CANTUNARCHIVE', 'Poruku nije moguæe dearhivirati');
...
DEFINE ('_UDDEADM_SHOWTEXTCOUNTER_HEAD', 'Prikaži brojaè znakova');
DEFINE ('_UDDEADM_SHOWTEXTCOUNTER_EXP', 'Prikazuje brojaè znakova koji prikazuje koliko je znakova još ostalo.');
DEFINE ('_UDDEIM_CLEAR', 'Oèisti');
DEFINE ('_UDDEADM_ALLOWMULTIPLEUSER_HEAD', 'Pridruži odabrane korisnike listi');
DEFINE ('_UDDEADM_ALLOWMULTIPLEUSER_EXP', 'Ovo omoguæava odabir višestrukih primatelja.');
DEFINE ('_UDDEADM_CBALLOWMULTIPLEUSER_HEAD', 'Pridruži odabrane veze listi');
DEFINE ('_UDDEADM_CBALLOWMULTIPLEUSER_EXP', 'Ovo omoguæava odabir višestrukih primatelja.');
DEFINE ('_UDDEADM_PMSFOUND', 'PMS pronaðen: ');
...
DEFINE ('_UDDEADM_OBFUSCATING_HEAD', 'Kljuè za maskiranje poruka');
DEFINE ('_UDDEADM_OBFUSCATING_EXP', 'Upišite kljuè koji se koristi za maskiranje poruke. Nemojte mijenjati ovu vrijednost nakon što je funkcija maskiranja poruka ukljuèena.');
DEFINE ('_UDDEADM_CFGFILE_NOTFOUND', 'Pronaðena kriva konfiguracijska datoteka!');
DEFINE ('_UDDEADM_CFGFILE_FOUND', 'Pronaðena verzija:');
DEFINE ('_UDDEADM_CFGFILE_EXPECTED', 'Oèekivana verzija:');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING', 'Konverzija konfiguracije...');
DEFINE ('_UDDEADM_CFGFILE_DONE', 'Gotovo!');
DEFINE ('_UDDEADM_CFGFILE_WRITEFAILED', 'Kritièna greška: Konfiguracijska datoteka nije otvorena za zapisivanje:');

// New: 0.8+
DEFINE ('_UDDEIM_ENCRYPTDOWN', 'Šifrirana poruka! - Preuzimanje nije moguæe!');
DEFINE ('_UDDEIM_WRONGPASSDOWN', 'Pogrešna zaporka! - Preuzimanje nije moguæe!');
DEFINE ('_UDDEIM_WRONGPW', 'Pogrešna zaporka! - Kontaktirajte administratora baze!');
DEFINE ('_UDDEIM_WRONGPASS', 'Pogrešna zaporka!');
DEFINE ('_UDDEADM_MAINTENANCE_D1', 'Pogrešni datumi Smeæa (ulazna/izlazna pošta): ');
...
DEFINE ('_UDDEADM_SHOWACTIONICONS_EXP', 'Kad je postavljeno na <i>Da</i>, s ikonom æe se prikazivati ikone radnji.');
DEFINE ('_UDDEIM_UNCHECKALL', 'ne oznaèi ništa');
DEFINE ('_UDDEIM_CHECKALL', 'oznaèi sve');
DEFINE ('_UDDEADM_SHOWBOTTOMICONS_HEAD', 'Prikaži donje ikone');
DEFINE ('_UDDEADM_SHOWBOTTOMICONS_EXP', 'Kad je postavljeno na <i>Da</i>, s ikonom æe se prikazivati donji linkovi.');
DEFINE ('_UDDEADM_ANIMATED_HEAD', 'Koristiti animirane smajlije');
DEFINE ('_UDDEADM_ANIMATED_EXP', 'Koristiti animirane smajlije umjesto statiènih smajlija.');
DEFINE ('_UDDEADM_ANIMATEDEX_HEAD', 'Više animiranih smiley-ja');
DEFINE ('_UDDEADM_ANIMATEDEX_EXP', 'Prikazati dodatne animirane smajliæe.');
...
DEFINE ('_UDDEADM_MAINTENANCE_EXP', 'Kad je korisnik izbrisan iz baze podataka, njegove poruke su obièno saèuvane u bazi podataka. Ova funkcija provjerava da li je potrebno brisati poruke koje nikome ne pripadaju, a možete ih i izbrisati ako to želite.');
...
DEFINE ('_UDDEADM_MAINTENANCE_NOTFOUND', "nije pronaðeno (od/za/postavke/bloker/blokirano):");
...
DEFINE ('_UDDEIM_NOMESSAGES_TRASHCAN', 'Nemate poruka u smeæu.');
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_MANUALLY', 'ruèno');
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_EXP', 'Automatsko brisanje optereæuje server. Ako izaberete <b>Samo&nbsp;administratori</b>, automatsko brisanje poziovat æe se kad admin provjeri svoju ulaznu poštu. Odaberite ovu opciju ako administrator redovno provjerava svoju ulaznu poštu. Manji sajtovi mogu odabrati <b>Bilo&nbsp;koji&korisnik</b>.');

DEFINE ('_UDDEADM_SETTINGSSAVED', 'Postavke su spremljene.');

// admin import tab
DEFINE ('_UDDEADM_CONTINUE', 'nastavi');
DEFINE ('_UDDEADM_IMPORT_EXP', 'Ovo neæe izmijeniti vaše stare PMS poruke ili vašu instalaciju. Poruke æe biti neošteæene. Možete ih bez problema importirati u uddeIM, èak i ako mislite i dalje koristiti stari PMS. Prije importiranja trebali bi ste prvo saèuvati sve izmjene postavki koje ste napravili. Sve poruke koje se veæ nalaze u vašoj uddeIM bazi podataka ostat æe neošteæene i neizmijenjene.');
...
DEFINE ('_UDDEADM_CHARSET_EXP', 'Ako imate problema s prikazivanjem slova koja nisu latin, ovdje možete upisati set znakova (charset) kojeg æe uddeIM koristiti za prikazivanje informacija iz baze podataka u HTML kodu. <b>Ako ne znate što to znaèi, nemojte mjenjati postavljenu vrijednost!</b>');
DEFINE ('_UDDEADM_MAILCHARSET_HEAD', 'Znakovi u upotrebi za mail');
DEFINE ('_UDDEADM_MAILCHARSET_EXP', 'Ako imate problema s prikazivanjem slova koja nisu latin1, ovdje možete upisati set znakova (charset) kojeg æe uddeIM koristiti za slanje izlazne pošte. Standardna vrijednost valjana je za veæinu europskih jezika.');
...
DEFINE ('_UDDEADM_SHOWSETTINGSLINK_EXP', 'Link za postavke pojaviti æe se u uddeIM ako imate aktivirane e-mail obavijesti ili sistem blokiranja. Možete odrediti poziciju ili možete iskljuèiti postavku.');
...
"Pozdrav %you%,\n\n%user% poslao vam je privatnu poruku na %site%. Molimo vas da se prijavite na stranice kako bi ste ju proèitali!\n\n%livesite%");
...
"Pozdrav %you%,\n\nimate neproèitane privatne poruke na %site%. Molimo vas da se prijavite na stranice kako bi ste ih proèitali!\n\n%livesite%");
