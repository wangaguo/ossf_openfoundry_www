	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<table class="adminlist">
				<tr>
					<td>
						...
						$link = 'index.php?option='.$option.'&amp;view=reguser';
						EventListViewEventList::quickiconButton( $link, 'icon-48-groups.png', JText::_( 'reguser' ) );

						$link = 'index.php?option='.$option.'&amp;view=vip';
						EventListViewEventList::quickiconButton( $link, 'icon-48-vip.png', JText::_( 'VIP' ) );
						
						$link = 'index.php?option='.$option.'&amp;view=blacklist';
						EventListViewEventList::quickiconButton( $link, 'icon-48-black.png', JText::_( 'black' ) );
						
						$link = 'index.php?option='.$option.'&amp;view=mail_list';
						EventListViewEventList::quickiconButton( $link, 'icon-48-mail.png', JText::_( 'MAIL MANAGEMENT' ) );
			...
			?>
				<table class="adminlist">
					<tr>
						<td><?php echo JText::_( 'EVENTS PUBLISHED' ).': '; ?></td>
						<td><b><?php echo $this->events[0]; ?></b></td>
					</tr>
					<tr>
						<td><?php echo JText::_( 'EVENTS UNPUBLISHED' ).': '; ?></td>
						<td><b><?php echo $this->events[1]; ?></b></td>
					</tr>
					<tr>
						<td><?php echo JText::_( 'EVENTS ARCHIVED' ).': '; ?></td>
						<td><b><?php echo $this->events[2]; ?></b></td>
					</tr>
					<tr>
						<td><?php echo JText::_( 'EVENTS TOTAL' ).': '; ?></td>
						<td><b><?php echo $this->events[3]; ?></b></td>
					</tr>
				</table>
				<?php
				...
				<table class="adminlist">
					<tr>
						<td><?php echo JText::_( 'VENUES PUBLISHED' ).': '; ?></td>
						<td><b><?php echo $this->venue[0]; ?></b></td>
					</tr>
					<tr>
						<td><?php echo JText::_( 'VENUES UNPUBLISHED' ).': '; ?></td>
						<td><b><?php echo $this->venue[1]; ?></b></td>
					</tr>
					<tr>
						<td><?php echo JText::_( 'VENUES TOTAL' ).': '; ?></td>
						<td><b><?php echo $this->venue[2]; ?></b></td>
					</tr>
				</table>
				<?php
				...
				<table class="adminlist">
					<tr>
						<td><?php echo JText::_( 'CATEGORIES PUBLISHED' ).': '; ?></td>
						<td><b><?php echo $this->category[0]; ?></b></td>
					</tr>
					<tr>
						<td><?php echo JText::_( 'CATEGORIES UNPUBLISHED' ).': '; ?></td>
						<td><b><?php echo $this->category[1]; ?></b></td>
					</tr>
					<tr>
						<td><?php echo JText::_( 'CATEGORIES TOTAL' ).': '; ?></td>
						<td><b><?php echo $this->category[2]; ?></b></td>
					</tr>
				</table>
				<?php
				echo $this->pane->endPanel();
