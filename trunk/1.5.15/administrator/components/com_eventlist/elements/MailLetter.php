...
class JElementMailLetter extends JElement
{
   /**
	* Element name
	*
	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		$event =& JTable::getInstance('eventlist_mail_list', '');
		if ($value) {
			$event->load($value);
		} else {
		...
		$link = 'index.php?option=com_eventlist&amp;view=MailLetterelement&amp;tmpl=component';
