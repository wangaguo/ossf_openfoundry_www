...
<?php echo $pl->signature; ?>&nbsp;
    ...
    <tr>
        <th align = "center" colspan = "7"> <?php echo $pageNavSP->writePagesLinks(); ?>
        </th>
    </tr>
...
?>
        ...
        <SCRIPT LANGUAGE = "Javascript">
            ...
            for ($i = 0; $i < count($uploaded); $i++)
            {
                ...
                $query
                    = $type ? "SELECT mesid FROM #__fb_attachments where filelocation='".FB_ABSUPLOADEDPATH."/images/$uploaded[$i]'"
                    : "SELECT mesid FROM #__fb_attachments where filelocation='".FB_ABSUPLOADEDPATH."/files/$uploaded[$i]'";
                ...
                echo $type ? '<a href="' . $uploaded_path . '/' . $uploaded[$i] . '" target="_blank" title="' . _COM_A_IMGB_ENLARGE . '" alt="' . _COM_A_IMGB_ENLARGE . '"><img src="' . $uploaded_path . '/' . $uploaded[$i]
                         . '" width="80" heigth="80" border="0"></a>' : '<a href="'
                         . $uploaded_path . '/' . $uploaded[$i] . '" title="' . _COM_A_IMGB_DOWNLOAD . '" alt="' . _COM_A_IMGB_DOWNLOAD . '"><img src="/administrator/components/com_fireboard/images/fbfile.png"   border="0"></a>';
        ...
        <form action = "index2.php" method = "POST" name = "adminForm">
            ...
            <table class = "adminlist" border = "0" cellspacing = "0" cellpadding = "3" width = "100%">
                ...
                <?php
                    ...
                    <tr class = "row<?php echo $k;?>">
                                <td width = "20">
                                    <input type = "checkbox" id = "cb<?php echo $i;?>" name = "id" value = "<?php echo $s->id; ?>" onClick = "isChecked(this.checked);">
                                </td>
                                <td width = "10">
...
<?php
        ...
        <form action = "index2.php" method = "POST" name = "adminForm">
            <table cellpadding = "4" cellspacing = "0" border = "0" width = "100%" class = "adminform">
				...
				<tr>
					<td colspan="2" align="center"><input type = "hidden" name = "option" value = "<?php echo $option; ?>"> <input type = "hidden" name = "task" value = "showsmilies"> <input type = "hidden" name = "boxchecked" value = "0"><input type = "hidden" name = "id" value = "<?php echo $smileycfg['id']; ?>"></td>
				</tr>
			</table>
        </form>
        ...
        <form action = "index2.php" method = "POST" name = "adminForm">
            <table cellpadding = "4" cellspacing = "0" border = "0" width = "100%" class = "adminform">
				...
				<tr>
					<td colspan="2" align="center"><input type = "hidden" name = "option" value = "<?php echo $option; ?>"> <input type = "hidden" name = "task" value = "showsmilies"> <input type = "hidden" name = "boxchecked" value = "0"></td>
				</tr>
			</table>
        </form>
 ...
 function showRanks( $option,$mosConfig_lang,&$ranks,$pageNavSP,$order,$rankpath )  
  ...
  <table class="adminlist" border=0 cellspacing=0 cellpadding=3 width="100%" >
    ...
    <tr class="row<?php echo $k;?>">
      ...
      <td width="20" align="center"><input type="checkbox" id="cb<?php echo $id;?>" name="id" value="<?php echo $row->rank_id; ?>" onClick="isChecked(this.checked);"></td>
    ...
    <td><input class="post" type="text" name="rank_min" value="1" /></td>
			...
			<tr>
				...
				<td><input type="checkbox" name="rank_special" value="1" /></td>
					...
					<td colspan="2" align="center"><input type = "hidden" name = "option" value = "<?php echo $option; ?>"> <input type = "hidden" name = "task" value = "showRanks"> <input type = "hidden" name = "boxchecked" value = "0"></td>
			</tr>
		</table>
  </form>
...
?>
  ...
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminform">
			...
			<tr align="center">
				<td width="100"><?php echo _FB_RANKSIMAGE; ?></td>
				<td><select name="rank_image" onchange="update_rank(this.options[selectedIndex].value);"><?php echo $filename_list; ?></select> &nbsp; <img name="rank_image" src="<?php echo $edit_img; ?>" border="0" alt="" /><?php echo $edit_img; ?></td>
			</tr>
   <tr>
				<td width="100"><?php echo _FB_RANKSMIN; ?></td>
    <td><input class="post" type="text" name="rank_min" value="<?php echo $row->rank_min;?>" /></td>
			...
			<tr>
				...
				<td><input type="checkbox" name="rank_special" value="1"<?php if($row->rank_special == 1) { echo 'checked="checked"';} ?> /></td>
					...
					<td colspan="2" align="center"><input type = "hidden" name = "option" value = "<?php echo $option; ?>"> <input type = "hidden" name = "task" value = "showRanks"> <input type = "hidden" name = "boxchecked" value = "0"><input type = "hidden" name = "id" value = "<?php echo $row->rank_id; ?>"></td>
			</tr>
		</table>
  </form>
