...
DEFINE('_FB_EMOTICONS_MORE_SMILIES', '更多表情');
...
//
DEFINE('_FB_FORUM_TOP', '跳轉討論版');
DEFINE('_FB_CHILD_BOARDS', 'Child Boards ');
DEFINE('_FB_QUICKMSG', 'Quick Reply ');
DEFINE('_FB_THREADS_IN_FORUM', '討論版');
DEFINE('_FB_FORUM', '討論區');
...
DEFINE('_FB_PATHWAY_VIEWING', '位瀏覽者');
...
DEFINE('_POST_SUCCESS_POSTED', '您的訊息已發佈');
DEFINE('_POST_SUCCESS_VIEW', '[ 返回到已發佈的話題 ]');
DEFINE('_POST_SUCCESS_FORUM', '[ 返回到討論版 ]');
...
DEFINE('_IMAGE_SELECT_FILE', '附上選擇圖檔');
DEFINE('_FILE_SELECT_FILE', '附上選擇檔案');
...
DEFINE('_GEN_MARK_ALL_FORUMS_READ', '標註所有話題已閱讀');
DEFINE('_GEN_MARK_THIS_FORUM_READ', '標註已閱讀');
...
DEFINE('_COM_A_FLAT', '平滑瀏覽');
DEFINE('_COM_A_THREADED', '樹狀瀏覽');
...
DEFINE('_GEN_BY', '由');
DEFINE('_GEN_CANCEL', '取消');
DEFINE('_GEN_CONTINUE', '送出');
DEFINE('_GEN_DATE', 'Date');
DEFINE('_GEN_DELETE', 'Delete');
DEFINE('_GEN_EDIT', 'Edit');
DEFINE('_GEN_EMAIL', 'Email');
DEFINE('_GEN_EMOTICONS', '表情');
DEFINE('_GEN_FLAT', '平滑瀏覽');
DEFINE('_GEN_FLAT_VIEW', '平滑瀏覽');
DEFINE('_GEN_FORUMLIST', 'Forum List');
DEFINE('_GEN_FORUM', '討論版');
DEFINE('_GEN_HELP', 'Help');
DEFINE('_GEN_HITS', 'Views');
DEFINE('_GEN_LAST_POST', '最新回覆');
DEFINE('_GEN_LATEST_POSTS', '顯示最新發表');
...
DEFINE('_GEN_MESSAGE', '內容');
DEFINE('_GEN_MODERATED', 'Forum is moderated; Reviewed prior to publishing.');
DEFINE('_GEN_MODERATORS', '版主');
DEFINE('_GEN_MOVE', 'Move');
DEFINE('_GEN_NAME', '姓名');
DEFINE('_GEN_POST_NEW_TOPIC', '發表新話題');
DEFINE('_GEN_POST_REPLY', 'Post Reply');
DEFINE('_GEN_MYPROFILE', '我的個人資料');
DEFINE('_GEN_QUOTE', 'Quote');
DEFINE('_GEN_REPLY', 'Reply');
DEFINE('_GEN_REPLIES', '回覆');
DEFINE('_GEN_THREADED', '樹狀瀏覽');
DEFINE('_GEN_THREADED_VIEW', '樹狀瀏覽');
...
DEFINE('_GEN_SUBJECT', '主旨');
DEFINE('_GEN_SUBMIT', 'Submit');
DEFINE('_GEN_TOPIC', 'Topic');
DEFINE('_GEN_TOPICS', '話題');
DEFINE('_GEN_TOPIC_ICON', '標籤');
DEFINE('_GEN_SEARCH_BOX', '搜尋話題');
$_GEN_THREADED_VIEW = "樹狀瀏覽";
$_GEN_FLAT_VIEW = "平滑瀏覽";
//avatar_upload.php
