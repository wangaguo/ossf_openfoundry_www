...
define('_COM_SEF_DEF_404_MSG','<h1>Schlechtes Karma : Wir konnten diese Seite nicht finden!</h1>
...
define('_COM_SEF_SH_FB_INSERT_NAME',				'Kunenaname einfügen');
define('_COM_SEF_SH_FB_NAME',						'Standard Kunenaname');
define('_COM_SEF_SH_FB_TITLE',						'Kunena Konfiguration ');
...
define('_COM_SEF_TT_SH_FB_INSERT_NAME',				'Wenn aktiviert, wird der Kunenatitle zu allen Kunenaurls vorangestellt');
define('_COM_SEF_TT_SH_FB_NAME',					'Wenn aktiviert, wird der Kunenaname allen Kunenaurls vorangestellt');
