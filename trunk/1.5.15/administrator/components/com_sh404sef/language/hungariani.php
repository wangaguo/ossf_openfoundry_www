...
define('_COM_SEF_SH_FB_INSERT_NAME', 'A Kunena nevének beszúrása');
define('_COM_SEF_SH_FB_NAME', 'A Kunena alapértelmezett neve');
define('_COM_SEF_SH_FB_TITLE', 'Kunena beállításai ');
...
define('_COM_SEF_TT_SH_FB_INSERT_NAME', 'Az <strong>Igen</strong> választása esetén a Kunena főoldalához vezető menüpont címe hozzáfűzésre kerül a Kunena összes keresőbarát URL-jéhez');
define('_COM_SEF_TT_SH_FB_NAME', 'Az <strong>Igen<strong> választása esetén a Kunena neve (a Kunena menüpontban meghatározottak szerint) mindig hozzáfűzésre kerül a keresőbarát URL-hez.');
