...
$version = "1.5.10.446 - <a href=\"http://dev.anything-digital.com/sh404SEF/\">dev.anything-digital.com/sh404SEF/</a>";
$Enabled = "0";
$replacement = "-";
$pagerep = "-";
$stripthese = ",|~|!|@|%|^|(|)|<|>|:|;|{|}|[|]|&|`|„|‹|’|‘|“|”|•|›|«|´|»|°";
...
$defaultComponentStringList = array("comprofiler"=>"","contact"=>"","content"=>"","contentsubmit"=>"","customproperties"=>"Community","docman"=>"","eventlist"=>"Workshop","fireboard"=>"","jcomments"=>"","joomfish"=>"","letterman"=>"Newsletter","mtimporter"=>"","mtree"=>"","newsfeeds"=>"","poll"=>"","pollxt"=>"","search"=>"","uddeim"=>"","user"=>"","weblinks"=>"","wrapper"=>"");
