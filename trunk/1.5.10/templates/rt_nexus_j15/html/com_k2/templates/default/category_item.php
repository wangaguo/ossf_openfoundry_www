...
<div class="itemContainer <?php echo $this->isGroup; ?>">
	...
	<div class="itemHeader">
		...
		<!-- Item edit link -->
		<span class="k2EditLink"><a class="modal" rel="{handler:'iframe',size:{x:1000,y:650}}" href="<?php echo $this->item->editLink;?>"><?php echo JText::_('Edit item');?></a></span>
		<?php endif; ?>
	...
	<?php if ($this->item->params->get('catItemAuthor') or ((($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) && $this->item->numOfComments>0 && $this->item->params->get('itemComments') && $this->item->params->get('catItemCommentsAnchor'))): ?>
	<div class="k2-author-block">
...
<?php endif; ?>
	...
	<div class="itemBody">
	  ...
	  <?php $image = 'image'.$this->item->params->get($this->isGroup.'ImgSize'); if ($this->item->params->get('catItemImage') && !empty($this->item->$image)):?>
	   <!-- Item image -->
	  <div class="itemImageMainBlock">
	    ...
	    <?php endif; ?>
		<img src="<?php echo $this->item->$image; ?>" alt="<?php echo $this->item->image_caption;?>" />
