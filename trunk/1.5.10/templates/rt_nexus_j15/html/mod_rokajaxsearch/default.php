...
<div class="rokajaxsearch<?php echo $params->get('moduleclass_sfx'); ?>">
	<div class="input-field-l"><div class="input-field-r"><input id="roksearch_search_str" name="searchword" type="text" class="inputbox" value="<?php echo JText::_('SEARCH'); ?>" /></div></div>
