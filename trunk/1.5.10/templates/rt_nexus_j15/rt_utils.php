...
$mainmodulesBlocks = array(
	...
	'case2' => array('feature', 'feature2', 'feature3'),
	'case3' => array('user1', 'user2', 'user3'),
	'case4' => array('user4', 'user5', 'user6'),
	'case5' => array('bottom', 'bottom2', 'bottom3'),
	'case6' => array('user7', 'user8', 'user9'),
	'case7' => array('footer', 'footer2', 'footer3')
);
...
$featuremod_count = ($this->countModules('feature')>0) + ($this->countModules('feature2')>0) + ($this->countModules('feature3')>0);
$featuremod_width = $featuremod_count > 0 ? ' w' . floor(99 / $featuremod_count) : '';
