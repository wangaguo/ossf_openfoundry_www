...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>Sie haben keine%s Nachrichten%s in ihrem%s.</b>');	// see next also six lines
...
DEFINE ('_UDDEADM_CBGALLERY_HEAD', 'Zeige CB-Galerie Avatare');
