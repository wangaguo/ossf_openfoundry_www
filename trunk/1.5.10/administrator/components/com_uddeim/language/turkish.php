...
// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', ' mesajlar');
DEFINE ('_UDDEMODULE_7DAYS', ' son 7 gündeki mesajlar');
DEFINE ('_UDDEMODULE_30DAYS', ' son 30 gündeki mesajlar');
DEFINE ('_UDDEMODULE_365DAYS', ' son 365 gündeki mesajlar');
...
DEFINE ('_UDDEADM_NOCB', '<span style="color: red;">Joomla Community Builder kurulu değil. uddeIM\'i kullanamayacaksınız.</span><br><br><a href="http://www.joomlapolis.com/">Community Builder</a>\'ı indirebilirsiniz.');
...
DEFINE ('_UDDEADM_DELETIONS', 'Silinme'); // changed in 0.4
