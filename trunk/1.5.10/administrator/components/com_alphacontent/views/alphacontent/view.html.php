...
class configurationViewAlphacontent extends JView {
	...
	function edit($tpl = null) {
		...
		$options[] = JHTMLSelect::Option( '3', JText::_( 'AC_METADESC' ) );
		...
		$options[] = JHTMLSelect::Option( 'comments', 'Simple comment system' );
		$options[] = JHTMLSelect::Option( 'chrono_comments', 'ChronoComments' );
		$options[] = JHTMLSelect::Option( 'msComment_Comment', 'MS Comment' );
		$options[] = JHTMLSelect::Option( 'mxc_comments', 'mXcomment' );
		...
		$options = array();
		$options[] = JHTMLSelect::Option( '1',  JText::_( 'AC_TITLEAZ' ) );
		$options[] = JHTMLSelect::Option( '2',  JText::_( 'AC_TITLEZA' ) );
		$options[] = JHTMLSelect::Option( '3',  JText::_( 'AC_DATECREATEDASC' ) );
		$options[] = JHTMLSelect::Option( '4',  JText::_( 'AC_DATECREATEDDESC' ) );
		$options[] = JHTMLSelect::Option( '5',  JText::_( 'AC_DATEMODIFIEDASC' ) );
		$options[] = JHTMLSelect::Option( '6',  JText::_( 'AC_DATEMODIFIEDDESC' ) );
		$options[] = JHTMLSelect::Option( '7',  JText::_( 'AC_HITSASC' ) );
		$options[] = JHTMLSelect::Option( '8',  JText::_( 'AC_HITSDESC' ) );
		$options[] = JHTMLSelect::Option( '9',  JText::_( 'AC_RATINGASC' ) );
		$options[] = JHTMLSelect::Option( '10',  JText::_( 'AC_RATINGDESC' ) );
		$options[] = JHTMLSelect::Option( '11',  JText::_( 'AC_AUTHORASC' ) );
		$options[] = JHTMLSelect::Option( '12',  JText::_( 'AC_AUTHORDESC' ) );
		$options[] = JHTMLSelect::Option( '13',  JText::_( 'AC_FEATURED' ) );
