...
define('_JOOMLAFISH_PREAMBLE', 'PREAMBLE');
...
define('_JOOMFISH_RELATED_TOPICS','Related topics');
define('_JOOMFISH_HELP','Joom!Fish help, credits and the rest of the universe');
define('_JOOMFISH_MENU_DOC','The dinner menu <b>(The Documentation)</b>');
define('_JOOMFISH_DOCANDTUTORY','Documentation & Tutorials');
define('_JOOMFISH_PROJECT_DOC_SITE','Project Documentation Site');
define('_JOOMFISH_INSTALLATION','Installation notes (ReadMe)');
define('_JOOMFISH_CHANGELOG','Changelog');
define('_JOOMFISH_OFFICIAL_PROJECT_WEBSITE','Official Project WebSite');
define('_JOOMFISH_OFFICIAL_PROJECT_FORUM','Official Project Forum');
define('_JOOMFISH_BUHTRACKER','Bugtracker');
define('_JOOMFISH_LICENSE','License');
define('_JOOMFISH_THINK_NETWORK','Think Network Open Source license ');
define('_JOOMFISH_ADDITIONAL_SITES','Additional Sites');
define('_JOOMFISH_README','Read ME');
define('_JOOMFISH_PRESENT','To all the people of the JoomFish community!<br />Present development team');
define('_JOOMFISH_LOGODESIGN','Logo design by');
