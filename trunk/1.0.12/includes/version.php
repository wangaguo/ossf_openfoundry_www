...
class joomlaVersion {
	...
	/** @var string Date + Add By Eddy*/
	var $RELDATE_C 	= '4 October 2006';
	/** @var string Time */
	var $RELTIME 	= '01:00';
	/** @var string Timezone */
	var $RELTZ 		= 'UTC';
	...
	/** @var string URL */
	var $URL 		= '<a href="http://www.joomla.org">Joomla!</a>是基於GNU/GPL授權的自由軟體. 中文版本由<a href="http://www.joomla.org.tw">TaiwanJoomla</a>製作.';
