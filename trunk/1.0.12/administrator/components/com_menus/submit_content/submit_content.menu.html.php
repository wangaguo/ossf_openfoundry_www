...
class submit_content_menu_html {
	...
	function edit( &$menu, &$lists, &$params, $option ) {
		...
		<tr>
			<th>
			<?php echo $menu->id ? $_LANG->_('Edit') : $_LANG->_('Add');?> <?php echo $_LANG->_('Menu Item :: Submit - Content') ;?>
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					...
					<?php
					if ( !$menu->id ) {
						echo mosToolTip( $_LANG->_('If you leave this blank the Section name will be automatically used') );
					}
					?>
					</td>
				</tr>
