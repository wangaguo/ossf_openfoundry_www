...
define('_COM_SEF_DISABLED',"<p class='error'>LET OP: SEF ondersteuning in Joomla is op dit moment uitgeschakeld. Schakel SEF in via uw<a href='".$GLOBALS['mosConfig_live_site']."/administrator/index2.php?option=com_config'> Algemene instellingen</a> SEO pagina.</p>");
define('_COM_SEF_EDIT','Bewerk');
define('_COM_SEF_EMPTYURL','U moet een URL opgeven voor doorverwijzing');
define('_COM_SEF_ENABLED','Toegestaan');
...
define('_COM_SEF_NORECORDS','Geen tabellen in de database gevonden.');
...
define('_COM_SEF_WARNDELETE','LET OP!!!<br/>U staat op het punt om te verwijderen ');
...
define('_COM_SEF_SH_CONF_META_DOC', 'PAS OP : Om het beheer van de titel, omschrijving, sleutelwoorden, robots en taal tags te activeren, <strong>dient u de shCustomTags module te publiceren</strong>. Deze is automatisch ge&iuml;nstalleerd bij installatie van sh404SEF. De <strong>positie</strong> van deze module maakt veel uit. Leest u alstublieft de documentatie van deze module om zeker te zijn van een goede werking. <br/>Voor sh404SEF zijn verschillende plugins beschikbaar die <strong>automatisch</strong> META tags maken voor sommige componenten. Probeer deze niet handmatig te maken, tenzij u de automatisch gemaakte tags niet vindt passen !!<br>');
define('_COM_SEF_SH_REMOVE_JOOMLA_GENERATOR', 'Verwijder Joomla Generator tag');
define('_COM_SEF_TT_SH_REMOVE_JOOMLA_GENERATOR', 'Als u deze instelt op <strong>Ja</strong>, zal de generator = Joomla META tag verwijderd worden van elke pagina waar de shCustomTags module is gepubliceerd');
...
define('_COM_SEF_TT_SH_LOG_ATTACKS', 'Als u deze instelt op Ja, zullen ge&iuml;dentificeerde aanvallen worden gelogd in een tekst bestand, inclusief het IP adres van de aanvaller en het gemaakte paginaverzoek.<br />Er is 1 log bestand per maand. Deze zijn te vinden in de <site root>/administrator/com_sef/logs map. U kunt deze downloaden via FTP, of een Joomla extensie gebruiken zoals Joomla Explorer om ze te bekijken. Het zijn TAB gescheiden tekst bestanden, dus uw spreadsheet software zal ze gemakkelijk kunnen openen, wat wellicht de handigste manier is om ze te bekijken.');	            
