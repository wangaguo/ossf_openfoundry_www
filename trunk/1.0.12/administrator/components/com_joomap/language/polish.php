...
if( !defined( 'JOOMAP_LANG' )) {
    ...
    define("_JOOMAP_CFG_EXPAND_CATEGORIES","Rozwiñ kategorie artyku³ów");
    define("_JOOMAP_CFG_EXPAND_SECTIONS","Rozwiñ sekcje artyku³ów");
    define("_JOOMAP_CFG_SHOW_MENU_TITLES", "Poka¿ tytu³y menu");
    define("_JOOMAP_CFG_NUMBER_COLUMNS", "Ilo¶æ kolumn");
    define('_JOOMAP_EX_LINK', 'Oznaczenie linków zewnêtrznych');
    ...
    define('_JOOMAP_MSG_OVERRIDE_WRITE_PROTECTION', 'Zmieñ prawa do pliku na czas zapisywania zmian.');
    define('_JOOMAP_GOOGLE_LINK',			'Link do Google');

    // -- Tips ---------------------------------------------------------------------
    define('_JOOMAP_EXCLUDE_MENU_TIP',		'Okre¶l pozycje menu, których nie chcesz w³±czyæ do mapy serwisu.<br /><strong>UWAGA</strong><br />Oddziel ID przecinkami!');
    ...
    // -- Menus --------------------------------------------------------------------
    define("_JOOMAP_CFG_SET_ORDER", "Ustaw kolejno¶æ wy¶wietlania pozycji menu");
    define("_JOOMAP_CFG_MENU_SHOW", "Poka¿");
    define("_JOOMAP_CFG_MENU_REORDER", "Przestaw");
    define("_JOOMAP_CFG_MENU_ORDER", "Kolejno¶æ");
    define("_JOOMAP_CFG_MENU_NAME", "Nazwa menu");
    define("_JOOMAP_CFG_DISABLE", "Kliknij, by WY³±czyæ");
    define("_JOOMAP_CFG_ENABLE", "Kliknij, by W³±czyæ");
    ...
    // -- Errors -------------------------------------------------------------------
    define('_JOOMAP_ERR_NO_LANG','Nie znaleziono jêzyka [ %s ], wczytano domy¶lny jêzyk komunikatów: angielski<br />'); // %s = $GLOBALS['mosConfig_lang']
    define('_JOOMAP_ERR_CONF_SAVE',         '<h2>Zapisanie konfiguracji nie powiod³o siê.</h2>');
    define('_JOOMAP_ERR_NO_CREATE',         'B£¡D: Nie mo¿na utworzyæ w BD tabeli z ustawieniami)');
    define('_JOOMAP_ERR_NO_DEFAULT_SET',    'B£¡D: Nie mo¿na odczytaæ domy¶lnych ustawieñ');
    define('_JOOMAP_ERR_NO_PREV_BU',        'Ostrze¿enie: Nie mo¿na usun±c poprzeniej kopii zapasowej');
    define('_JOOMAP_ERR_NO_BACKUP',         'B£¡D: Nie mo¿na utworzyæ kopii zapasowej');
    define('_JOOMAP_ERR_NO_DROP_DB',        'B£¡D: Nie mo¿na usun±æ tabeli bazy danych z ustawieniami');

    // -- Config -------------------------------------------------------------------
    define('_JOOMAP_MSG_SET_RESTORED',      'Ustawienia zosta³y przywrócone<br />');
    ...
    define('_JOOMAP_MSG_SET_DB_DROPPED',    'Tabela BD z ustawieniami zosta³a usuniêta.');
