...
if( !defined( 'JOOMAP_LANG' )) {
    ...
    // -- Errors -------------------------------------------------------------------
    define('_JOOMAP_ERR_NO_LANG','Aucun fichier de la langue [ %s ] n\'a pas &eacute;t&eacute; trouv&eacute;, la langue par d&eacute;faut est: anglais<br />'); // %s = $GLOBALS['mosConfig_lang']
    ...
    define('_JOOMAP_ERR_NO_DROP_DB',        'ERREUR: Impossible de supprimer la table de préférences');
