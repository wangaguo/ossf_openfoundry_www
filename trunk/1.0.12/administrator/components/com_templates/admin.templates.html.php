...
class HTML_templates {
	...
	*/
	function showTemplates( &$rows, &$pageNav, $option, $client ) {
		...
		<tr>
			<th class="templates">
			<?php echo $_LANG->_( 'Template Manager');?> <small><small>[ <?php echo $client == 'admin' ? $_LANG->_( 'Administrator') : $_LANG->_( 'Site');?> ]</small></small>
			</th>
	...
	*/
	function editTemplateSource( $template, &$content, $option, $client ) {
		...
		<tr>
			...
			<td width="220">
				<span class="componentheading"><?php echo $_LANG->_( 'index.php is');?> :
	...
	*/
	...
	global $_LANG;
		...
		<tr>
			...
			<?php echo $_LANG->_( 'Assign template');?> <?php echo $template; ?> <?php echo $_LANG->_( 'to menu items');?>
			</th>
		</tr>
		<tr>
