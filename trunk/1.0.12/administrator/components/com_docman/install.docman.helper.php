 ...
 * @version $Id: install.docman.helper.php 561 2008-01-17 11:34:40Z mjaz $
 * @package DOCman_1.4
...
class DMInstallHelper {
    function checkWritable()
    {
        ...
        {
            if(!is_writable($mosConfig_absolute_path.DS.$path))
            {
            	$msgs[] =  '<font color="red">Unwriteable: '. $path . '</font><br />';
            }
        }
    ...
    function setAdminMenuImages(){
      global $database;
        ...
        $submenus[] = array( 'image' => _DM_INSTALLER_ICONPATH.'dm_credits_16.png', 'name'=>'Credits' );
