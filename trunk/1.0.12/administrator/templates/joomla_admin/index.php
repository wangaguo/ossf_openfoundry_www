...
<link rel="stylesheet" href="templates/joomla_admin/css/template_css<?php echo $_LANG->rtl() ? '_rtl': ''; ?>.css" type="text/css" />
<link rel="stylesheet" href="templates/joomla_admin/css/theme<?php echo $_LANG->rtl() ? '_rtl': ''; ?>.css" type="text/css" />
...
<tr>
	<td align="center">
		...
		<div align="center" class="smallgrey">
				<?php echo $version; ?>
				<br/>
				<a href="http://www.joomla.org/latest10" target="_blank"><?php echo $_LANG->_( 'Check for latest Version')?></a>
			</div>
		<?php
		if ( $mosConfig_debug ) {
