...
$fckphp_config['basedir'] = $mosConfig_absolute_path ;
...
/*------------------------------------------------------------------------------*/
$fckphp_config['urlprefix'] = $mosConfig_live_site;
...
$fckphp_config['uploadProgressHandler']=$mosConfig_live_site."/cgi-bin/progress.cgi"; //Perl upload progress handler
/*==============================================================================*/
...
//Flash area
$fckphp_config['ResourceAreas']['images/Flash'] =array(
...
$fckphp_config['ResourceAreas']['images'] =array(
	...
	//Files(identified by extension) that may be uploaded to this area
	'AllowedExtensions'	=>	array("zip","doc","xls","pdf","rtf","csv","jpg","gif","jpeg","png","avi","mpg","mpeg","tiff","tif","mp3"),
...
/*------------------------------------------------------------------------------*/
//$fckphp_config['ResourceTypes'] = array('File','Image','images/Flash','Media', 'images');
$fckphp_config['ResourceTypes'] = array('images/Flash', 'images');
