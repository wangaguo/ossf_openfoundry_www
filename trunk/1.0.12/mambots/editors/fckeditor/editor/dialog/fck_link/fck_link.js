...
function SetLinkType( linkType )
{
	...
	ShowE('divLinkTypeContent'  , (linkType == 'content') ) ;
	ShowE('divLinkTypeDocman'  , (linkType == 'docman') ) ;
	

	if ( !FCKConfig.LinkDlgHideTarget )
		window.parent.SetTabVisibility( 'Target'	, (linkType == 'url'|| linkType == 'content'|| linkType == 'docman') ) ;
