...
$shInsertNumericalIdCatList = array("56","133","59","134","60","51","55","32","57","54","33","34","63","61","62","64","142","105","138","149","203","147","143","110","148","144","145","107","204","106","213","108","137","151","109","111","150","187","152","146","182","228","218","25","131","27","26","23","31","132","70","67","68","69","66","202","197","52","37","53","195","38");
...
$shMTreeInsertListingId = "0";
$shMTreePrependListingId = "0";
...
$shSecAntiFloodPeriod = "30";
$shSecAntiFloodCount = "10";
$shLangTranslateList = array("english"=>"1");
$shLangInsertCodeList = array("english"=>"0");
$defaultComponentStringList = array("contact"=>"","docman"=>"Download","docman13rc2_patch"=>"","eventcal"=>"","gallery2"=>"","gcalendar"=>"","jfcei"=>"","joomap"=>"","joomfish"=>"","letterman"=>"Newsletter","login"=>"","mtree"=>"ResourceCatalog","newsfeeds"=>"","poll"=>"","rd_rss"=>"","search"=>"Search","weblinks"=>"");
$pageTexts = array("traditional_chinese"=>"Page-%s","english"=>"Page-%s");
$shAdminInterfaceType = 2;
$shInsertNoFollowPDFPrint = "1";
$shInsertReadMorePageTitle = "0";
$shMultipleH1ToH2 = "1";
$shVmUsingItemsPerPage = "0";
$shSecCheckPOSTData = "0";
$shSecCurMonth = 0;
$shSecLastUpdated = 0;
$shSecTotalAttacks = 0;
...
$defaultComponentItemidList = array("contact"=>"","docman"=>"","docman13rc2_patch"=>"","eventcal"=>"","gallery2"=>"","gcalendar"=>"","jfcei"=>"","joomap"=>"","joomfish"=>"","letterman"=>"","login"=>"","mtree"=>"","newsfeeds"=>"","poll"=>"","rd_rss"=>"","search"=>"","weblinks"=>"");
$UseDefaultItemids = "1";
