 ...
 * gj.pms.uddeim.php
 * 
 * This file contains extended PMS class for UddeIm
...
* @package groupjive
*/
class uddeim_pms extends gj_pms {
	...
	function validate() {
		...
		// currently not needed, maybe we can change "Group Messenger"
		// to subject - IMO this makes more sense (MP)
	...
	function send () {
		...
		if ($this->validate()) {
			...
			$sql="INSERT INTO #__uddeim"
				. "\n(fromid, toid, message, datum, systemmessage,"
				. "\ndisablereply)"
				. "\nVALUES (".$this->_from->id.", ".$this->_to->id.", '"
				. escapeString($this->message)."', ".$timestamp.", '"
				. $sysflag."', ".$disablereply.")";
