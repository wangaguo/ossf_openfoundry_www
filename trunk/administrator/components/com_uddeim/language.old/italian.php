...
// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', ' messaggi');
DEFINE ('_UDDEMODULE_7DAYS', ' messaggi ultimi 7 giorni');
DEFINE ('_UDDEMODULE_30DAYS', ' messaggi ultimi 30 giorni');
DEFINE ('_UDDEMODULE_365DAYS', ' messaggi ultimi 365 giorni');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Nota:<br />Quando usi mosMail, devi configurare un indirizzo e-mail valido!</b>');
DEFINE ('_UDDEIM_FILTEREDMESSAGE', 'messaggio filtrato');
DEFINE ('_UDDEIM_FILTEREDMESSAGES', 'messaggi filtrati');
DEFINE ('_UDDEIM_FILTER', 'Filtro:');
DEFINE ('_UDDEIM_FILTER_TITLE_INBOX', 'Mostra solo quelli di questo utente');
DEFINE ('_UDDEIM_FILTER_TITLE_OUTBOX', 'Mostra solo quelli verso questo utente');
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', 'solo quelli non letti');
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Filtro');
DEFINE ('_UDDEIM_FILTER_ALL', '- tutti -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- utenti pubblici -');
DEFINE ('_UDDEADM_FILTER_HEAD', 'Abilita Filtro');
DEFINE ('_UDDEADM_FILTER_EXP', 'Se abilitato, gli utenti possono filtrare i messaggi in entrata e in uscita per mostrare un solo destinatario.');
DEFINE ('_UDDEADM_FILTER_P0', 'disabilitato');
DEFINE ('_UDDEADM_FILTER_P1', 'sopra la lista dei messaggi');
DEFINE ('_UDDEADM_FILTER_P2', 'sotto la lista dei messaggi');
DEFINE ('_UDDEADM_FILTER_P3', 'sopra e sotto la lista');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>Hai no%s messages%s your%s.</b>');	// see next six lines
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' non letto/i');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_FROM', ' da questo utente');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_TO', ' verso questo utente');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_INBOX', ' ricevuto/i');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUBOX', ' spedito/i');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_ARCHIVE', ' in archivio');
DEFINE ('_UDDEIM_TODP_TITLE', 'Destinatario');
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'Uno o pi&ugrave; destinatari (separati da una virgola)');
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', 'Quando selezionato, la lista di tutti i destinatari verr&agrave; aggiunta al messaggio.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '...imposta come default per autorisponditore, autoinoltro, inputbox, filtro');
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', 'Abilita AutoRisponditore');
DEFINE ('_UDDEADM_AUTORESPONDER_EXP', 'Quando l&rsquo;autorisponditore &egrave; abilitato l&rsquo;utente pu&ograve; attivare la notifica nelle proprie impostazioni.');
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Abilita AutoRisponditore');
DEFINE ('_UDDEIM_AUTORESPONDER', 'AutoRisponditore');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Quando l&rsquo;autorisponditore &egrave; abilitato, ad ogni messaggio ricevuto sar&agrave; immediatamente data risposta.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Spiacente, al momento non sono disponibile.\nController&ograve; tutti i messaggi ricevuti non appena possibile.");
DEFINE ('_UDDEADM_USERSET_AUTOR', 'AutoRisp');
DEFINE ('_UDDEADM_USERSET_SELAUTOR', '- AutoRisp -');
DEFINE ('_UDDEIM_USERBLOCKED', 'L&rsquo;utente &egrave; bloccato.');
DEFINE ('_UDDEADM_AUTOFORWARD_HEAD', 'Abilita AutoInoltro');
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Quando l&rsquo;AutoInoltro &egrave; attivo l&rsquo;utente pu&ograve; automaticamente inoltrare i messaggi in arrivo ad un altro utente.');
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', 'Abilita AutoInoltro');
DEFINE ('_UDDEADM_USERSET_AUTOF', 'AutoIn');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- AutoIn -');
DEFINE ('_UDDEIM_AUTOFORWARD', 'AutoInoltro');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'I nuovi messaggi possono essere automaticamente inoltrati ad un altro utente.');
DEFINE ('_UDDEIM_THISISAFORWARD', 'AutoInoltro di un messaggio originariamente indirizzato a ');
DEFINE ('_UDDEADM_COLSROWS_HEAD', 'Message box (col/righe)');
DEFINE ('_UDDEADM_COLSROWS_EXP', 'Specifica il numero di colonne e righe del message box (default 60/10).');
DEFINE ('_UDDEADM_WIDTH_HEAD', 'Message box (largh)');
DEFINE ('_UDDEADM_WIDTH_EXP', 'Specifica la larghezza del message box in pixel (default 0). Se tale valore &egrave; 0, sar&agrave; utilizzata la larghezza specificata nel file CSS.');
...
DEFINE ('_UDDEADM_PUBLIC', 'Pubblico');
...
DEFINE ('_UDDEADM_EMN_BODY_NOMESSAGE_EXP', 'Questo &egrave; il contenuto della e-mail che gli utenti riceveranno quando &egrave; impostata l&rsquo;opzione sopra. Il contenuto del messaggio non sar&agrave; nella email. Mantieni intatte le variabili %you%, %user% e %site% . ');
DEFINE ('_UDDEADM_EMN_BODY_WITHMESSAGE_EXP', 'Questo &egrave; il contenuto della e-mail che gli utenti riceveranno quando &egrave; impostata l&rsquo;opzione sopra. Questa email include il contenuto del messaggio. Mantieni intatte le variabili %you%, %user%, %pmessage% e %site% . ');
DEFINE ('_UDDEADM_EMN_FORGETMENOT_EXP', 'Questo &egrave; il contenuto della e-mail promemoria che gli utenti riceveranno quando &egrave; impostata l&rsquo;opzione sopra. Mantieni intatte le variabili %you% e %site%. ');
...
DEFINE ('_UDDEADM_EXPORT_FORMAT_EXP', 'Questo &egrave; il formato della e-mail che gli utenti riceveranno quando scaricheranno i propri messaggi dall&rsquo;archivio. Mantieni intatte le variabili %user%, %msgdate% e %msgbody% . ');
