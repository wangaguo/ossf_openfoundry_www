...
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', 'Usar <i>sí</i> si tienes Community Builder instalado y quieres presentar al usuario los nombres de sus conexiones al escribir un mensaje.');
