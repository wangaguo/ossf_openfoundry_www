...
//	if(count($remodir)<2) { echo $lastdiradded; } else { echo $list_remodir; }
			    ...
			    <tr align="center" valign="middle">
				    <td align="left" valign="top">
						<strong><?php echo _UDDEADM_FILTER_HEAD; ?></strong></td>
					<td align="left" valign="top">
				    	<?php
				        $shflt[] = mosHTML::makeOption( '0', _UDDEADM_FILTER_P0 );
				        $shflt[] = mosHTML::makeOption( '1', _UDDEADM_FILTER_P1 );
				        $shflt[] = mosHTML::makeOption( '2', _UDDEADM_FILTER_P2 );
				        $shflt[] = mosHTML::makeOption( '3', _UDDEADM_FILTER_P3 );
				        $list_shflt = mosHTML::selectList( $shflt, 'config_enablefilter', 'class="inputbox" size="1"', 'value', 'text', $config->enablefilter );
				        echo $list_shflt;
					    ?>
					</td>
				    <td align="left" valign="top" width="50%">
						<?php echo _UDDEADM_FILTER_EXP; ?>
					</td>
			    </tr>
			    <tr align="center" valign="middle">
				    <td align="left" valign="top">
			    ...
			    <tr align="center" valign="middle">
				    <td align="left" valign="top">
						<strong><?php echo _UDDEADM_COLSROWS_HEAD; ?></strong></td>
					<td align="left" valign="top">
						<input type="text" name="config_cols" size="4" value="<?php echo $config->cols; ?>" /> /
						<input type="text" name="config_rows" size="4" value="<?php echo $config->rows; ?>" />
					</td>
				    <td align="left" valign="top" width="50%">
			    ...
			    <tr align="center" valign="middle">
				    <td align="left" valign="top">
						<strong><?php echo _UDDEADM_WIDTH_HEAD; ?></strong></td>
					<td align="left" valign="top">
						<input type="text" name="config_width" size="4" value="<?php echo $config->width; ?>" />
					</td>
				    <td align="left" valign="top" width="50%">
						<?php echo _UDDEADM_WIDTH_EXP; ?>
					</td>
			    </tr>
			    <tr align="center" valign="middle">
				    <td align="left" valign="top">
		...
		?>
			<table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminForm">	
			    ...
			    <tr align="center" valign="middle">
					...
					<td align="left" valign="top"<?php echo $adminstyle; ?>>
				    	<?php
				        if (uddeIMcheckCBE2())	$cbl[] = mosHTML::makeOption( '4', _UDDEADM_CBE );
			    ...
			    <tr align="center" valign="middle">
					...
					<td align="left" valign="top">
				    	<?php
				        if (uddeIMcheckCBE2())	$cbp[] = mosHTML::makeOption( '4', _UDDEADM_CBE );
...
//				        $list_lwe = mosHTML::selectList( $lwe, 'config_longwaitingemail', 'class="inputbox" size="2"', 'value', 'text', $config->longwaitingemail );
			    ...
			    <tr align="center" valign="middle">
					...
					<td align="left" valign="top"<?php echo $adminstyle; ?>>
						<input type="text" name="config_emn_sendername" size="20" value="<?php echo uddeIMquotestrip($config->emn_sendername); ?>" /> 
					</td>
				    <td align="left" valign="top" width="50%"<?php echo $adminstyle; ?>>
			    ...
			    <tr align="center" valign="middle">
					...
					<td align="left" valign="top">
						<input type="text" name="config_emn_sendermail" size="20" value="<?php echo $config->emn_sendermail; ?>" /> 
					</td>
				    <td align="left" valign="top" width="50%">
						<?php echo _UDDEADM_EMN_SENDERMAIL_EXP; 
							if ($config->mailsystem==1) {	// mosMail
								if (preg_match("/[\w\.\-]+@\w+[\w\.\-]*?\.\w+/", $config->emn_sendermail )==false) {
									echo _UDDEADM_EMN_SENDERMAIL_WARNING;
								}
							}
						?>
					</td>
			    ...
			    <tr align="center" valign="middle">
				    <td align="left" valign="top"<?php echo $adminstyle; ?>>
						<strong><?php echo _UDDEADM_AUTORESPONDER_HEAD; ?></strong>
					</td>
					<td align="left" valign="top"<?php echo $adminstyle; ?>>
				    	<?php
						$lsar[] = mosHTML::makeOption( '2', _UDDEADM_ADMINSONLY );
						$lsar[] = mosHTML::makeOption( '1', _UDDEADM_YES );
						$lsar[] = mosHTML::makeOption( '0', _UDDEADM_NO );
						$list_lsar = mosHTML::selectList( $lsar, 'config_autoresponder', 'class="inputbox" size="1"', 'value', 'text', $config->autoresponder );
						echo $list_lsar;
					    ?>
					</td>
				    <td align="left" valign="top" width="50%"<?php echo $adminstyle; ?>>
						<?php echo _UDDEADM_AUTORESPONDER_EXP; ?>
					</td>
			    </tr>						
			    <tr align="center" valign="middle">
				    <td align="left" valign="top">
						<strong><?php echo _UDDEADM_AUTOFORWARD_HEAD; ?></strong>
					</td>
					<td align="left" valign="top">
				    	<?php
						$lsaf[] = mosHTML::makeOption( '2', _UDDEADM_ADMINSONLY );
						$lsaf[] = mosHTML::makeOption( '1', _UDDEADM_YES );
						$lsaf[] = mosHTML::makeOption( '0', _UDDEADM_NO );
						$list_lsaf = mosHTML::selectList( $lsaf, 'config_autoforward', 'class="inputbox" size="1"', 'value', 'text', $config->autoforward );
						echo $list_lsaf;
					    ?>
					</td>
				    <td align="left" valign="top" width="50%">
						<?php echo _UDDEADM_AUTOFORWARD_EXP; ?>
					</td>
			    </tr>						
			    <tr align="center" valign="middle">
				    <td align="left" valign="top"<?php echo $adminstyle; ?>>
