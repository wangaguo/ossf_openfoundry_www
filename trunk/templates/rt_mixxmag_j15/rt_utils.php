...
global $Itemid, $modules_list, $mainmodulesBlocks, $template_real_width, $leftcolumn_width, $rightcolumn_width;
...
$mainmodulesBlocks = array(
	...
	'case4' => array('footer2', 'footer3', 'footer4')
);
...
$mainmod4_count = ($this->countModules('footer2')>0) + ($this->countModules('footer3')>0) + ($this->countModules('footer4')>0);
$mainmod4_width = $mainmod4_count > 0 ? ' w' . floor(99 / $mainmod4_count) : '';

$leftcolumn_width = ($this->countModules('left')>0 or $this->countModules('advertisement1')>0 or $this->countModules('advertisement2')>0 or ($subnav and $splitmenu_col=="leftcol")) ? $leftcolumn_width : "0";
$rightcolumn_width = ($this->countModules('right')>0 or $this->countModules('advertisement3')>0 or $this->countModules('advertisement4')>0 or ($subnav and $splitmenu_col=="rightcol")) ? $rightcolumn_width : "0";
