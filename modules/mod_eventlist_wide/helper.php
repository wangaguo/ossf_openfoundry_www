<?php
/**
 * @version 0.9 $Id: helper.php 620 2008-04-15 13:06:24Z schlu $
 * @package Joomla
...
class modEventListwideHelper
{
	...
	function getList(&$params)
	{
		...
		$query = 'SELECT a.title, a.dates, a.enddates, a.times, a.datimage, l.venue, l.state, l.locimage, l.city, c.catname,'
	...
	function _format_date($row, &$params)
	{
		...
		if($params->get('datemethod', 1) == 2) {
			...
			//format date
			$result = strftime($params->get('formatdate', '%d.%m.%Y'), strtotime( $row->dates.' '.$row->times ));
		}
		return $result;
	}
	/**
