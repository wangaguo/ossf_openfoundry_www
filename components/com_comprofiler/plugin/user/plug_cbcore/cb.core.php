...
//					$html			=	$this->_fieldEditToHtml( $field, $user, $reason, 'input', 'multicheckbox', $value, '', $allValues );
					...
					if ( ( $list_compare_types == 0 ) && ( $field->type != 'multicheckbox' ) ) {
					...
					$html			=	$this->_fieldSearchModeHtml( $field, $user, $html, ( strpos( $field->type, 'multi' ) === 0 ? 'multiplechoice' : 'singlechoice' ), $list_compare_types, $jqueryclass );
				} else {
