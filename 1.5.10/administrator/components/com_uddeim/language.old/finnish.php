...
//
// For Version: uddeIM 1.5
// Dated: 17.12.2008
// Translation version: 0.7
//
// Please, take the contact for authors or our Finnish forum if you see some mistakes in this language file.
// *******************************************************************

// New: 1.6
DEFINE ('_UDDEIM_HELP', 'Tuki');
DEFINE ('_UDDEIM_HELP_HEADLINE1', 'uddeIM Tuki');
...
DEFINE ('_UDDEADM_ENABLERSS_HEAD', 'Salli RSS');
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Kun tämä toiminto on sallittuna, viestit voi saada RSS syötteenä. Käyttäjät löytävät vaadittavan URL:n heidän profiilistaan.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...aseta oletukseksi RSS, iGoogle, tuki, erotin');
...
DEFINE ('_UDDEIM_PMNAV_THEREARERESPONSES', 'Vastaus tähän:');
...
DEFINE ('_UDDEADM_PMNAV_HEAD', 'Salli siirtyminen');
DEFINE ('_UDDEADM_PMNAV_EXP', 'Näyttää siirtymisen viivan joka sallii siirtymisen aiheeseen.');
...
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', 'Lähetetään muistutus (Forgetmenot: %s päivänä):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', '%s päivinä lähetetyt muistutukset:');
...
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Aikajana:');
...
DEFINE ('_UDDEADM_FILTER_HEAD', 'Salli suodatus');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>Sinulla on%s viestiä%s :%s.</b>');	// see next six lines
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' lukematonta');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_FROM', ' tältä käyttäjältä');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_TO', ' tälle käyttäjälle');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_INBOX', ' saapuneita');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUBOX', ' lähetettyä');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_ARCHIVE', ' arkistoitua');
...
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', 'Salli automaattinen vastaus');
...
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Salli automaattinen vastaus');
...
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "En ole juuri tällä hetkellä paikalla.\nPalattuani, luen sähköpostini mahdollisimman pian.");
...
DEFINE ('_UDDEADM_AUTOFORWARD_HEAD', 'Salli välitys');
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Kun välitys on sallittuna, käyttäjä voi välittää uuden viestin toisille käyttäjille automaattisesti.');
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', 'Salli välitys');
DEFINE ('_UDDEADM_USERSET_AUTOF', 'Autom.välitys');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- Autom.välitys -');
DEFINE ('_UDDEIM_AUTOFORWARD', 'Välitä');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'Uudet viestit voi välittää toisille käyttäjälle automaattisesti.');
DEFINE ('_UDDEIM_THISISAFORWARD', 'Alkuperäinen viesti välitetty : ');
...
DEFINE ('_UDDEADM_WIDTH_EXP', 'Tämä määrittelee viestilaatikon leveyden pikseleissä (px)(oletus on 0). Jos arvo on 0, leveys määräytyy käytettävän CSS tyylin mukaan.');
DEFINE ('_UDDEADM_CBE', 'CB laajennus');
...
"Hei %you%, käyttäjä \n\n%user% on lähettänyt sinulle seuraavanlaisen yksityisviestin sivustolta %site%.\n__________________\n%pmessage%");
...
DEFINE ('_UDDEADM_POPUP_EXP','Näytä ponnahdusikkuna kun uusi viesti lähetetään (mod_uddeim tai korjattu mod_cblogin tarvitaan)');
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_EXP', 'Automaattinen viestien poistaminen kuormittaa palvelimia ja tietokantoja latausta paljon. Jos valitset <b>vain ylläpidon toimesta</b> asetusten mukaisesti tapahtuva viestien poistaminen (koskee kaikkia käyttäjiä) tapahtuu vain kun ylläpitäjä tarkistaa saapuneet-kansionsa. Valitse tämä jos ylläpitäjä (tai kuka tahansa ylläpitäjistä) tarkistaa saapuneet-kansionsa kerran päivässä tai useammin. Näin tapahtuu useimmilla sivustoilla. Jos ylläpitäjät tarkistavat viestit harvoin valitse <b>kenen tahansa käyttäjän toimesta</b>. Jos et tiedä, mitä tällä ajetaan takaa tai tarkoitetaan, valitse <b>kenen tahansa käyttäjän toimesta</b>.');
...
DEFINE ('_UDDEADM_NOCB', '<span style="color: red;">Mambo Community Builder -komponenttia ei ole asennettu. Et voi käyttää uddeIM:ä.</span><br><br>Haluat ehkä ladata <a href="http://www.mambojoe.com">Mambo Community Builder</a>.');
DEFINE ('_UDDEADM_CONTINUE', 'Jatka');
DEFINE ('_UDDEADM_PMSFOUND_1', 'Viestejä on ');
DEFINE ('_UDDEADM_PMSFOUND_2', ' vanhassa PMS asennuksessa. Haluatko tuoda nämä viestit uddeIM:iin?');
DEFINE ('_UDDEADM_IMPORT_EXP', 'Tämä ei muuta vanhaa PMS viesteja tai asennustasi. Ne pidetään vahingoittumina ja voit turvallisesti tuoda ne uddeIM:iin, vaikka haluaisitkin vielä käyttää vanhaa PMS:ä. Sinun tulee tallentaa kaikki muutoksesi asetuksiin ennen kuin aloitat tuonnin! Kaikki viestit, jotka ovat jo uddeIM:n tietokannassasi pysyvät vahingoittumina.');
...
DEFINE ('_UDDEADM_COPYTOME_HEAD', 'Salli kopiot itselle');
DEFINE ('_UDDEADM_COPYTOME_EXP', 'Salli käyttäjien vastaanottaa kopio lähetetyistä viesteistä. Kopiot näkyvät saapuneet-kansiossa.');
...
DEFINE ('_UDDEIM_HELPON_SYSGM_2', '(avautuu uuteen ikkunaan)');

DEFINE ('_UDDEIM_SYSGM_PLEASECONFIRM', 'Olet lähettämässä alla näkyvää viestiä. Tarkista vielä viestin sisältö ja vahvista tai peru.');
...
DEFINE ('_UDDEIM_EMNOFF', 'Sähköpostimuistutus on pois päältä. ');
DEFINE ('_UDDEIM_EMNON', 'Sähköpostimuistutus on päällä. ');
DEFINE ('_UDDEIM_SETEMNON', '[laita päälle]');
DEFINE ('_UDDEIM_SETEMNOFF', '[laita pois päältä]');
