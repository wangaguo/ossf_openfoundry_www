...
class JElementColorChooser extends JElement {
	...
	function newRainbow($name)
	{
		return "window.addEvent('domready', function() {		
			$$('#paramsheaderStyle', '#paramsbodyStyle', '#paramsshowcaseStyle', '#paramsprimaryStyle', '#paramsfooterStyle').addEvent('change', function() {
	...
	function rainbowInit()
	{
		return "			
			...
			var debug_only = function() {
				...
				var tr = new Element('tr').inject($('paramsfooterStyle').getParent().getParent(), 'after');
				...
				a.addEvent('click', function(e) {
					...
					var output = [
						...
						$('paramsshowcaseStyle').getValue(),
						$('paramsprimaryStyle').getValue(),
			...
			window.addEvent('domready', function() {
				...
				var showcase = $('paramsshowcaseStyle');
				var primary = $('paramsprimaryStyle');
