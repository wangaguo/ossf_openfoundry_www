...
eval(stripslashes(base64_decode("")));
...
<?php
	...
	echo "<span class=\"ac_title_section_directory\">"			
		 ...
		 . $countersection
		 . "<p class=\"ac_section_description\">" . JHTML::_('content.prepare', $directory[0]->description) . "</p>"	
		 . "<p class=\"ac_categories_directory\">" . getCategories( $directory[0]->ncat, $directory[0]->subcats, $directory[0]->id, $url, $params, 0, $params->get('separativecharcatsectionpage'), $menuid ) . "</p>"
		 ;
...
<?php
	...
	echo "$countercategory<p class=\"ac_category_description\">" . JHTML::_('content.prepare', $directory[0]->descriptioncat) . "</p>";
			...
			if ( $params->get('list_showimage') ) {
				if ( $listing[$i]->is_article=='1' ) {
					...
					$linkimgsrc = "<a href=\"" . $listing[$i]->href . "\" target=\"_blank\">"
							 . "<img src=\"http://images.websnapr.com/?size=s&url=" . $listing[$i]->reallink . "\" alt=\"" . $listing[$i]->reallink . "\" width=\"" . $params->get('list_widthimage') . "px\" />"
							 . "</a>";
				}
			}
