...
<tr>
	...
	<td>
		<input type="text" id="created_by_alias" name="created_by_alias" size="30" maxlength="100" value="<?php echo $this->article->created_by_alias; ?>" class="inputbox" />
	</td>
</tr>
<tr>
	<td class="key">
...
<tr>
	...
	<td>
		<textarea rows="5" cols="50" style="width:300px; height:50px" class="inputbox" id="metadesc" name="metadesc"><?php echo str_replace('&','&amp;',$this->article->metadesc); ?></textarea>
	</td>
</tr>
<tr>
	<td  valign="top" class="key">
	...
	<td>
		<textarea rows="5" cols="50" style="width:300px; height:50px" class="inputbox" id="metakey" name="metakey"><?php echo str_replace('&','&amp;',$this->article->metakey); ?></textarea>
	</td>
</tr>
</table>
</fieldset>
