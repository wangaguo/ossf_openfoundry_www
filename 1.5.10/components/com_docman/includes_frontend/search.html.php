...
* @version $Id: search.html.php 773 2009-01-08 17:38:08Z mathias $
* @package DOCman_1.4
* @copyright (C) 2003-2007 Joomlatools
...
class HTML_DMSearch
{
    function searchForm(&$lists, $search_phrase)
    {
        ...
        <form action="<?php echo sefRelToAbs($action);?>" method="post" name="adminForm" id="dm_frmsearch" class="dm_searchform">
            <tr height="30px">
