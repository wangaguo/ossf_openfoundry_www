 ...
 * @version $Id: upload.http.html.php 765 2009-01-05 20:55:57Z mathias $
 * @package DOCman_1.4
...
class HTML_DMUploadMethod
{
    function uploadFileForm($lists)
    {
        ...
        ob_start();
        ?>
		<form action="<?php echo sefRelToAbs($lists['action']) ;?>" method="post" enctype="multipart/form-data" id="dm_frmupload" class="dm_form">
