...
// saved at: 2009-01-08 11:46:51
// by: admin (id: 62 )
// domain: http://whoswho.iis.sinica.edu.tw
...
$shInsertNumericalIdCatList = array("1","3");
...
$shLangTranslateList = array("zh-TW"=>"0","en-GB"=>"0");
$shLangInsertCodeList = array("zh-TW"=>"0","en-GB"=>"0");
$defaultComponentStringList = array("comprofiler"=>"","contact"=>"","content"=>"","contentsubmit"=>"","eventlist"=>"workshop","fireboard"=>"","groupjive"=>"gruops","jomcomment"=>"","newsfeeds"=>"","poll"=>"","pollxt"=>"","search"=>"","uddeim"=>"","user"=>"","weblinks"=>"","wrapper"=>"");
