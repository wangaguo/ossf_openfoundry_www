...
class JCommentsACustomBBCodes
{
	...
	function save()
	{
		...
		$id = JCommentsInput::getParam($_REQUEST, 'id', 0);
		$acl = JCommentsInput::getParam($_REQUEST, 'button_acl', array());
		...
		if ($row->simple_pattern != '' && $row->simple_replacement_html != '') {
			...
			$tokens['SIMPLETEXT'] = array('([\w0-9-\+\.,_ ]+)' => '$1');
...
?>
<form action="<? echo JCOMMENTS_INDEX; ?>" method="post" name="adminForm">
<table class="adminheading">
	<tr>
<?php
		if ( JCOMMENTS_JVERSION == '1.0' ) {
?>
	<th style="background-image: none; padding: 0;"><img src="./components/com_jcomments/images/custombbcode48x48.png" width="48" height="48" align="middle" />&nbsp;<?php echo JText::_('Custom BBCode'); ?></th>
<?php
		}
?>
...
<table class="adminheading">
	<tr>
		<th style="background-image: none; padding: 0;"><img src="./components/com_jcomments/images/custombbcode48x48.png" width="48" height="48" align="middle">&nbsp;<?php echo JText::_('EDIT');?></th>
	</tr>
</table>
<?php
		}
		...
		<td>
			<fieldset>
				...
				<tr valign="top" align="left">
					...
					<td><input type="text" class="editbox long" size="35" name="button_title" value="<?php echo $row->button_title; ?>"></td>
					<td><?php echo JText::_('Title for this button'); ?></td>
				</tr>
				<tr valign="top" align="left">
					<td width="10%"><?php echo JText::_('Help line'); ?></td>
					<td><input type="text" class="editbox long" size="35" name="button_prompt" value="<?php echo $row->button_prompt; ?>"></td>
					<td><?php echo JText::_('Help line for this button'); ?></td>
				</tr>
				<tr valign="top" align="left">
					<td><?php echo JText::_('Icon'); ?></td>
					<td><input type="text" class="editbox long" size="35" name="button_image" value="<?php echo $row->button_image; ?>"></td>
					<td><?php echo JText::_('Path to button icon'); ?></td>
				</tr>
				<tr valign="top" align="left">
					<td><?php echo JText::_('CSS class'); ?></td>
					<td><input type="text" class="editbox short" size="35" name="button_css" value="<?php echo $row->button_css; ?>"></td>
					<td><?php echo JText::_('CSS class name for this button'); ?></td>
				</tr>
				<tr valign="top" align="left">
					<td width="10%"><?php echo JText::_('Open tag'); ?></td>
					<td><input type="text" class="editbox short" size="35" name="button_open_tag" value="<?php echo $row->button_open_tag; ?>"></td>
					<td><?php echo JText::_('The opening tag for this BBCode'); ?></td>
				</tr>
				<tr valign="top" align="left">
					<td><?php echo JText::_('Close tag'); ?></td>
					<td><input type="text" class="editbox short" size="35" name="button_close_tag" value="<?php echo $row->button_close_tag; ?>"></td>
