	...
	<tr>
		<td>
			...
			<div style="float: right;">
				<button type="button" onclick="submitbutton('addvenue')"><?php echo JText::_('SAVE') ?></button>
				<button type="button" onclick="window.parent.close()" /><?php echo JText::_('CANCEL') ?></button>
			</div>
		</td>
	</tr>
</table>
...
<table>
	...
	<tr>
		<td><label for="locimage"><?php echo JText::_( 'CHOOSE IMAGE' ).':'; ?></label></td>
	...
	<table class="adminform" width="100%">
		<tr>
  		...
  		<tr>
  			...
  			<td><input name="city" value="" size="55" maxlength="50" /></td>
  		</tr>
  		<tr>
  			<td><?php echo JText::_( 'STATE' ).':'; ?></td>
  			<td><input name="state" value="" size="55" maxlength="50" /></td>
  		</tr>
  		<tr>
  		  	<td><?php echo JText::_( 'COUNTRY' ).':'; ?></td>
  		  	<td>
				<input name="country" value="" size="4" maxlength="3" />&nbsp;
				<span class="editlinktip hasTip" title="<?php echo JText::_('NOTES'); ?>::<?php echo JText::_( 'COUNTRY HINT' ); ?>"><?php echo $infoimage; ?></span>
			</td>
		</tr>
<!--活動區域-->
	<tr>
...
<?php 
		...
		echo  JHTML::_('select.genericlist',  $area_sections, 'reg_area', 'class="inputbox" size="1" ', 'id', 'title', $row->reg_area); 
?>
		</td>
	</tr>
<!--活動區域end-->
