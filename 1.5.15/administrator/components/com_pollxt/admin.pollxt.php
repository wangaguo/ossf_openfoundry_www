...
$pollquestion = JRequest::getVar('pollquestion', 0, "", "", JREQUEST_ALLOWRAW);
...
function edit_settings($option) {
	...
	$config['tooltips'] = $xt_config->tooltips;
...
function save_settings($option, $conf) {
	...
	$xt_config->tooltips = $conf['tooltips'];
