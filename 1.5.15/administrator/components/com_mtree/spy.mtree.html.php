<?php
/**
 * @version		$Id: spy.mtree.html.php 609 2009-03-23 10:26:54Z CY $
 * @package		Mosets Tree
...
class HTML_mtspy {
	...
	<table class="adminheading" width="100%">
		<tr><td>
			...
			<table cellpadding="3">
				<tr><td colspan="2"><b><a href="<?php echo $mtconf->getjconf('live_site') . '/index.php?option=com_mtree&task=viewlink&link_id=' . $listing->link_id . '&Itemid='.$Itemid; ?>" target="_blank"><?php echo JText::_( 'View listing' ) ?></a> | <a href="index2.php?option=com_mtree&task=editlink&link_id=<?php echo $listing->link_id ?>"><?php echo JText::_( 'Edit' ) ?></a></b></td></tr>
	...
	<tr><td align="left" valign="top" width="160" height="0">
		<table cellpadding="2" cellspacing="0" border="0" width="160" height="100%" align="left" style="border: 1px solid #cccccc;background-color:#F1F3F5;clear:both;float:left;">
			...
			<tr>
				...
				<td width="100%"><a href="index2.php?option=com_mtree&task=spy&task2=users"><b><?php echo JText::_( 'View users' ) ?></b></a></td>
			</tr>
			<tr>
				<td><img src="../components/com_mtree/img/page_white.png" width="16" height="16" /> </td>
				<td><a href="index2.php?option=com_mtree&task=spy&task2=listings"><b><?php echo JText::_( 'View listings' ) ?></b></a></td>
			</tr>
			<tr>
				<td><img src="../components/com_mtree/img/group_error.png" width="16" height="16" /> </td>
				<td><a href="index2.php?option=com_mtree&task=spy&task2=clones"><b><?php echo JText::_( 'View clones' ) ?></b></a></td>
			</tr>
		...
		<div style="position:relative;top:5px;clear:both;text-align:center;"><img style="position:relative;top:4px;" src="../components/com_mtree/img/arrow_left.png" width="16" height="16" /> <a href="index2.php?option=com_mtree"><b><?php echo JText::_( 'Back to directory' ) ?></b></a></div>
