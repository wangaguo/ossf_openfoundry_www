...
function geocode() {
	...
	$listings = getUnGeocodedListings(5);
...
/*		width:420px;*/
	...
	jQuery(document).ready(function(){
		...
		if (GBrowserIsCompatible()) {
			...
			foreach( $listings AS $listing ) { 
				echo 'addRow("'.$listing->link_id.'", "'.$listing->link_name.'", "'.$listing->address.'", "'.$listing->city.'", "'.$listing->state.'", "'.$listing->postcode.'", "'.$listing->country.'")';
				echo "\n;";
			}
			?>
		} else {
		...
		<tr>
			<td width="620px" valign="top" id="listings">
				...
				<table width="100%" border=0 cellpadding=0 cellspacing=0>
					...
					<tfoot><tr><td colspan="2" align="right"><a href="javascript:getListings(10);"><?php echo JText::_( 'Load more listings' ); ?></a></td></tr></tfoot>
				</table>
				</div>
				<?php } ?>
				</fieldset>
