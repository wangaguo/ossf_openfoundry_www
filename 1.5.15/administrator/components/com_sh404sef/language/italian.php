...
define('_COM_SEF_SH_FB_INSERT_NAME', 'Inserisci nome Kunena');
define('_COM_SEF_SH_FB_NAME', 'Nome Kunena di default');
define('_COM_SEF_SH_FB_TITLE', 'Configurazione Kunena');
...
define('_COM_SEF_TT_SH_FB_INSERT_NAME', 'Se impostato su<strong> Si</strong>, il titolo dell&rsquo;elemento del menu che rimanda alla pagina principale di Kunena sar&agrave; esteso a tutte le SEF URL di Kunena');
define('_COM_SEF_TT_SH_FB_NAME', 'Se impostato su<strong> Si<strong>, il nome Kunena (come definito dal titolo di elemento di menu di Kunena) sar&agrave; sempre esteso alla SEF URL.');
