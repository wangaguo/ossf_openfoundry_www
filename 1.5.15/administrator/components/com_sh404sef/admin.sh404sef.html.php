 ...
 * @version     $Id: admin.sh404sef.html.php 1213 2010-04-07 09:17:01Z silianacom-svn $
 *
...
<table class="adminlist">
	...
	$lists['joomla_live_site'], 60, 255, $lists['joomla_live_site_style'], '</span>' );
...
<table class="adminlist">
	...
	if( $sefConfig->shAdminInterfaceType == SH404SEF_ADVANCED_ADMIN ) {
	  ...
	  echo HTML_sef::shYesNoParamHTML( $x,
	  _COM_SEF_SH_INSERT_ARTICLE_ID_TITLE,
	  _COM_SEF_TT_SH_INSERT_ARTICLE_ID_TITLE,
	  $lists['ContentTitleInsertArticleId'] );
	  $x++;
	  
	  echo HTML_sef::shYesNoParamHTML( $x,
	  _COM_SEF_SH_INSERT_NUMERICAL_ID_CAT_LIST,
	  _COM_SEF_TT_SH_INSERT_NUMERICAL_ID_CAT_LIST,
	  $lists['shInsertContentArticleIdCatList'] ); ?>
	...
	<!-- shumisha 2007-04-25 new params for Community Builder  -->
	<!-- shumisha 2010-04-04 new params for Jomsocial  -->
  <thead>
    <tr>
      <th class="title" style="text-align: left;" colspan="3"><?php echo _COM_SEF_SH_JS_TITLE; ?></th>
    </tr>
  </thead>
  <?php
  $x = 1;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_NAME,
  _COM_SEF_TT_SH_JS_INSERT_NAME . _COM_SEF_TT_SH_NAME_BY_COMP,
  $lists['shJSInsertJSName'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_CB_SHORT_USER_URL,
  _COM_SEF_TT_SH_CB_SHORT_USER_URL,
  $lists['shJSShortURLToUserProfile'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_USER_NAME,
  _COM_SEF_TT_SH_JS_INSERT_USER_NAME,
  $lists['shJSInsertUsername'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_USER_FULL_NAME,
  _COM_SEF_TT_SH_JS_INSERT_USER_FULL_NAME,
  $lists['shJSInsertUserFullName'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_CB_INSERT_USER_ID,
  _COM_SEF_TT_SH_CB_INSERT_USER_ID,
  $lists['shJSInsertUserId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_GROUP_CATEGORY,
  _COM_SEF_TT_SH_JS_INSERT_GROUP_CATEGORY,
  $lists['shJSInsertGroupCategory'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_GROUP_CATEGORY_ID,
  _COM_SEF_TT_SH_JS_INSERT_GROUP_CATEGORY_ID,
  $lists['shJSInsertGroupCategoryId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_GROUP_ID,
  _COM_SEF_TT_SH_JS_INSERT_GROUP_ID,
  $lists['shJSInsertGroupId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_GROUP_BULLETIN_ID,
  _COM_SEF_TT_SH_JS_INSERT_GROUP_BULLETIN_ID,
  $lists['shJSInsertGroupBulletinId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_DISCUSSION_ID,
  _COM_SEF_TT_SH_JS_INSERT_DISCUSSION_ID,
  $lists['shJSInsertDiscussionId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_MESSAGE_ID,
  _COM_SEF_TT_SH_JS_INSERT_MESSAGE_ID,
  $lists['shJSInsertMessageId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_PHOTO_ALBUM,
  _COM_SEF_TT_SH_JS_INSERT_PHOTO_ALBUM,
  $lists['shJSInsertPhotoAlbum'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_PHOTO_ALBUM_ID,
  _COM_SEF_TT_SH_JS_INSERT_PHOTO_ALBUM_ID,
  $lists['shJSInsertPhotoAlbumId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_PHOTO_ID,
  _COM_SEF_TT_SH_JS_INSERT_PHOTO_ID,
  $lists['shJSInsertPhotoId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_VIDEO_CAT,
  _COM_SEF_TT_SH_JS_INSERT_VIDEO_CAT,
  $lists['shJSInsertVideoCat'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_VIDEO_CAT_ID,
  _COM_SEF_TT_SH_JS_INSERT_VIDEO_CAT_ID,
  $lists['shJSInsertVideoCatId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JS_INSERT_VIDEO_ID,
  _COM_SEF_TT_SH_JS_INSERT_VIDEO_ID,
  $lists['shJSInsertVideoId'] );
 
  ?>
  <!-- shumisha 2010-04-04 new params for Jomsocial  -->
	<!-- shumisha 2010-04-05 new params for Kunena  -->
	<thead>
		<tr>
  ...
  _COM_SEF_SH_CB_SHORT_USER_URL,
  _COM_SEF_TT_SH_CB_SHORT_USER_URL,
  $lists['shFbShortUrlToProfile'] );
	$x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_FB_INSERT_USERNAME,
  _COM_SEF_TT_SH_FB_INSERT_USERNAME,
  $lists['shFbInsertUserName'] ); 
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_FB_INSERT_USER_ID,
  _COM_SEF_TT_SH_FB_INSERT_USER_ID,
  $lists['shFbInsertUserId'] ); 
	?>
	<!-- shumisha 2010-04-05 new params for Kunena  -->
...
<table class="adminform">
	...
	<?php 
	  if( $sefConfig->shAdminInterfaceType == SH404SEF_ADVANCED_ADMIN ) :
       $x=1;
        echo HTML_sef::shTextParamHTML( $x,
        _COM_SEF_SH_PAGE_NOT_FOUND_ITEMID,
        _COM_SEF_TT_SH_PAGE_NOT_FOUND_ITEMID,
        'shPageNotFoundItemid',
        $sefConfig->shPageNotFoundItemid, 10, 255);
    endif;
  ?>
	<tr>
		<td colspan="2"><?php
...
<table class="adminheading">
	<tr>
		...
		<?php if (!empty($lists['display_duplicate'])) : ?>
		<td nowrap="nowrap"><?php echo _COM_SEF_DISPLAY_DUPLICATE_URLS_TITLE.$lists['display_duplicate'];?></td>
		<?php endif; ?>
...
<table class="adminheading">
    ...
    <?php echo HTML_sef::shMessageHTML($message); ?> <input
	type="hidden" name="option" value="<?php echo $option;?>" /> <?php
