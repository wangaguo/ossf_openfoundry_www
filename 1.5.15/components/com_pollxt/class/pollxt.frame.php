...
var $activation = null;
	...
	function createFrame($id = "", $plugin = null, $conf = null) {
		...
		$this->html .= "<form name=\"".$name."\" action=\"\" onsubmit=\"return false\">";
...
/*		$publickey = "6Ldg9rkSAAAAAFFovrl2f-YZnaOp_6rINXq659K2";
		$error = null;
		$this->html .= "<script>var RecaptchaOptions = {theme : 'clean'};</script>";
		$this->html .= "<div id=\"captcha\" style=\"display:none\">".recaptcha_get_html($publickey, $error)."</div>";
*/
