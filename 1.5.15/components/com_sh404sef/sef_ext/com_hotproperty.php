 ...
 * @version     $Id: com_hotproperty.php 1356 2010-05-05 13:24:53Z silianacom-svn $
 *
...
$configFile = sh404SEF_ABS_PATH.'administrator/components/com_hotproperty/config.hotproperty.php';
...
$shHotPropName = (empty($shHotPropName) || $shHotPropName == '/') ? 'Forum':$shHotPropName;
