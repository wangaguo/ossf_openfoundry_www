...
class EventListModelEditevent extends JModel
{
		...
		if ($this->_id) {
			...
			*/
			...
			if ($session->has('eventform', 'com_eventlist')) {
				...
				$this->_event->candidate			= 0;
				$this->_event->reg_area			= 0;
				$this->_event->reg_msg			= null;
				$this->_event->reg_type			= 0;
				$this->_event->full				= 0;
				$this->_event->reg_free			= 0;
				$this->_event->vip_endtime 		= null;
				$this->_event->image_link 		= null;
				$this->_event->link_switch 		= null;
				$this->_event->open_date 		= null;
				$this->_event->open_time 		= null;
				$this->_event->reg_eat 			= null;
				$this->_event->survey			= null; 
				$this->_event->audit			= null;
	...
	function getVenues( )
	{
		...
		$query = 'SELECT l.id, l.venue, l.city, l.country, l.published, l.reg_area '
