...
class EventListModelCategoryevents extends JModel
{
	...
	function _buildQuery()
	{
		...
		$query = 'SELECT a.id AS eventid, a.dates, a.enddates, a.times, a.endtimes, a.title, a.locid, a.datdescription, a.created,  a.open_time, a.open_date, l.id, l.venue, l.city, l.state, l.url, c.catname, c.id AS catid, '
