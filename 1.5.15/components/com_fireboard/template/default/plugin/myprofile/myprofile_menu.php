...
<table class = "fb_blocktable" id = "fb_forumprofile" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
    ...
    <tbody class = "fb_myprofile_menu">
        <tr>
            ...
            <a href = "<?php echo sefRelToAbs(JB_LIVEURLREL . '&amp;func=myprofile&amp;do=userdetails'); ?>"> <?php echo _EDIT_TITLE; ?> </a> <a href = "<?php echo sefRelToAbs(JB_LIVEURLREL . '&amp;func=uploadavatar'); ?>"> <?php echo _FB_MYPROFILE_MYAVATAR; ?></a>
            </td>
        </tr>
