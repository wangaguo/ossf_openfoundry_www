...
<?php echo (int)$thread_counts[$leaf->id]; ?>
	...
	<span class="topic_posted_time"><?php echo _FB_POSTED_AT ?>  <?php echo date("Y-m-d, H:i:s",$leaf->time); ?><?php //echo time_since($leaf->time , time() + ($fbConfig->board_ofset * 3600)); ?> <?php// echo _FB_AGO ?>
        </span>
        <span class="topic_by">
  ...
  <!-- /Avatar -->
	...
	<?php //echo date("Y-m-d, H:i:s",$last_reply[$leaf-id]->time);?>
